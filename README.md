...
**394 Registry Keys · 19 ASR Rules · 124 Verification Checks · Complete Backup/Restore**
...
- **Telemetry Minimized** → 25+ services + 30 tasks + 394 registry keys configured for minimum data collection
...
| **Telemetry** | Privacy protection, App permissions | 25+ services, 394 registry keys (110 telemetry-specific), 37 app permission categories, Camera/Mic controls |

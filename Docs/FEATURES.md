...
| **ASR** | 19 | v2.2.4 | Attack Surface Reduction rules (Defender-specific API) |
...
| **TOTAL** | **633** | v2.2.4 | All 7 modules (Paranoid mode). With a third-party endpoint product as primary engine: 614 (ASR not applicable) |
...
Total Settings:             633 (Paranoid mode, Defender as primary engine)
                            614 (with third-party endpoint product — ASR not applicable)
Modules:                    7/7
Status:                     Released
Verification:               Tools/Verify-Complete-Hardening.ps1 covers all applied settings
BACKUP-APPLY-VERIFY-RESTORE: Implemented for all module-applied settings

Zero-Day Protection:        CVE-2025-9491 (SRP .lnk) + ClickFix (finger.exe block)
Microsoft Baseline:         MS Security Baseline for Windows 11 v25H2 implemented
Home User Friendly:         Interactive prompts for breaking-change decisions
Profile-Based Execution:    Balanced / Enterprise / Maximum
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```

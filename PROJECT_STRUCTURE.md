...
│
├── 📄 hosts                                  # DNS blocklist (107,772 domains, compressed)
│
...
- `Install-DNSBlocklist` - 107,772-domain hosts file (compressed to 12,025 lines)
...
**Domains**: 107,772 unique domains (Steven Black Unified, updated Nov 5, 2025)  
**Lines**: 12,025 (compressed format - 9 domains per line)  
**Size**: ~2.2 MB  

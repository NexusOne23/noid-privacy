...
|-------------|-----------|------------|------------|--------|
| **Native Defender** | 132/133 | 1 | 99% | ✅ Excellent |
| **Third-Party AV** | 110-114/133 | 19-23 | 83-86% | ✅ **Expected!** |
...
- ✅ **Bitdefender** - 110/133 PASS (RestrictRemoteSAM false positive, see above)
- ✅ **Kaspersky** - ~112/133 PASS (Defender features unavailable)
- ✅ **Norton/Symantec** - ~112/133 PASS (may flag script, add to exclusions)
- ✅ **ESET NOD32** - ~112/133 PASS (Defender features unavailable)
...
- ✅ **Windows Defender** (Microsoft) - 132/133 PASS

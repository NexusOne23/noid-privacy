...
Write-Host "  NoID Privacy Pro - Verification" -ForegroundColor Cyan
        ...
        foreach ($rule in $asrRules) {
            ...
            if ($index -ge 0) {
                ...
                if ($actualAction -eq $expectedAction) {
                    $results.Verified++
                    $actionText = if ($expectedAction -eq 1) { "Block" } elseif ($expectedAction -eq 2) { "Audit" } else { "Disabled" }
...
try {
    ...
    # Determine mode by checking AllowTelemetry (use Get-ItemProperty to avoid console errors)
    $telemetryKey = Get-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\DataCollection" -Name "AllowTelemetry" -ErrorAction SilentlyContinue
    $telemetryValue = $telemetryKey.AllowTelemetry
    $mode = if ($null -eq $telemetryValue) { "Not Applied" } 
    elseif ($telemetryValue -eq 0) { "Strict" }
    elseif ($telemetryValue -eq 1) { "MSRecommended" }
    else { "Unknown" }
    
    # Core Privacy Checks (34 total - 3 Data + 5 Ads + 3 Search + 6 Input + 11 AppPrivacy + 4 OneDrive + 2 Store)
    $checks = @(
        # Data Collection (3 checks)
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\DataCollection"; Name = "AllowTelemetry"; Value = 1; Desc = "AllowTelemetry (MSRecommended)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\DataCollection"; Name = "LimitDiagnosticLogCollection"; Value = 1; Desc = "Limit Diagnostic Log Collection" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\DataCollection"; Name = "DoNotShowFeedbackNotifications"; Value = 1; Desc = "No Feedback Notifications" },
        
        # Personalization & Ads (5 checks)
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent"; Name = "DisableTailoredExperiencesWithDiagnosticData"; Value = 1; Desc = "Disable Tailored Experiences" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent"; Name = "DisableWindowsSpotlightFeatures"; Value = 1; Desc = "Disable Spotlight Features" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent"; Name = "DisableWindowsSpotlightOnSettings"; Value = 1; Desc = "Disable Spotlight on Settings" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent"; Name = "DisableThirdPartySuggestions"; Value = 1; Desc = "Disable 3rd Party Suggestions" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AdvertisingInfo"; Name = "DisabledByGroupPolicy"; Value = 1; Desc = "Disable Advertising Info" },
        
        # Search & Cloud (3 checks)
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Windows Search"; Name = "DisableWebSearch"; Value = 1; Desc = "Disable Web Search" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Windows Search"; Name = "ConnectedSearchUseWeb"; Value = 0; Desc = "No Connected Search Web" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Windows Search"; Name = "AllowCloudSearch"; Value = 0; Desc = "No Cloud Search" },
        
        # Input & Sync (6 checks)
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\InputPersonalization"; Name = "AllowInputPersonalization"; Value = 0; Desc = "No Input Personalization" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System"; Name = "EnableActivityFeed"; Value = 0; Desc = "Disable Activity Feed" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System"; Name = "PublishUserActivities"; Value = 0; Desc = "No Publish User Activities" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System"; Name = "UploadUserActivities"; Value = 0; Desc = "No Upload User Activities" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\SettingSync"; Name = "DisableSettingSync"; Value = 2; Desc = "Settings Sync: User can enable (Value 2)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\SettingSync"; Name = "DisableSettingSyncUserOverride"; Value = 0; Desc = "Settings Sync: User can override (Value 0)" },
        
        # App Privacy (11 checks - user choice Value=0)
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"; Name = "LetAppsAccessLocation"; Value = 0; Desc = "Apps: Location (User decides)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"; Name = "LetAppsAccessRadios"; Value = 0; Desc = "Apps: Radios (User decides)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"; Name = "LetAppsAccessTrustedDevices"; Value = 0; Desc = "Apps: Trusted Devices (User decides)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"; Name = "LetAppsAccessCallHistory"; Value = 0; Desc = "Apps: Call History (User decides)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"; Name = "LetAppsAccessEmail"; Value = 0; Desc = "Apps: Email (User decides)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"; Name = "LetAppsAccessMessaging"; Value = 0; Desc = "Apps: Messaging (User decides)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"; Name = "LetAppsSyncWithDevices"; Value = 0; Desc = "Apps: Sync With Devices (User decides)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"; Name = "LetAppsAccessContacts"; Value = 0; Desc = "Apps: Contacts (User decides)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"; Name = "LetAppsAccessCalendar"; Value = 0; Desc = "Apps: Calendar (User decides)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"; Name = "LetAppsAccessMicrophone"; Value = 0; Desc = "Apps: Microphone (User decides)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"; Name = "LetAppsAccessCamera"; Value = 0; Desc = "Apps: Camera (User decides)" },
        
        # OneDrive (4 checks)
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\OneDrive"; Name = "EnableFeedbackAndSupport"; Value = 0; Desc = "OneDrive: No Feedback" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\OneDrive"; Name = "EnableSyncAdminReports"; Value = 0; Desc = "OneDrive: No Sync Reports" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\OneDrive"; Name = "DisablePersonalSync"; Value = 0; Desc = "OneDrive: Personal Allowed" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\OneDrive"; Name = "PreventNetworkTrafficPreUserSignIn"; Value = 1; Desc = "OneDrive: No Pre-Login Traffic" },
        
        # Microsoft Store (2 checks)
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\WindowsStore"; Name = "RemoveWindowsStore"; Value = 0; Desc = "Store: Enabled" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\WindowsStore"; Name = "DisableOSUpgrade"; Value = 1; Desc = "Store: Block OS Upgrade Prompts" }
    )
    
    foreach ($check in $checks) {
        $passed = Test-PrivacyRegistry -Path $check.Path -Name $check.Name -ExpectedValue $check.Value
        if ($passed) {
            $results.Verified++
            ...
            $results.Failed++
            $actual = "Not set or incorrect"
            try {
                if (Test-Path $check.Path) {
                    $actualVal = (Get-ItemProperty -Path $check.Path -Name $check.Name -ErrorAction SilentlyContinue).$($check.Name)
                    if ($null -ne $actualVal) { $actual = $actualVal }
                }
            }
            catch {}
...
# [ALWAYS] AntiAI Policies (24 checks)
Write-Host "[7/$totalSteps] Verifying AntiAI Policies (24 checks)..." -ForegroundColor Yellow

try {
    # Helper function for registry verification
    function Test-AntiAIRegistry {
        param($Path, $Name, $ExpectedValue)
        try {
            if (Test-Path $Path) {
                $actual = (Get-ItemProperty -Path $Path -Name $Name -ErrorAction SilentlyContinue).$Name
                
                # Handle MultiString arrays (Recall Deny Lists)
    ...
    # Check all AntiAI policies (dynamically counted)
    $checks = @(
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppPrivacy"; Name = "LetAppsAccessSystemAIModels"; Value = 2; Desc = "Generative AI Master" },
        @{ Path = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\systemAIModels"; Name = "Value"; Value = "Deny"; Desc = "CapabilityAccessManager AI Block" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsAI"; Name = "AllowRecallEnablement"; Value = 0; Desc = "Recall Removal" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsAI"; Name = "DisableAIDataAnalysis"; Value = 1; Desc = "Recall Snapshots (Device)" },
        @{ Path = "HKCU:\SOFTWARE\Policies\Microsoft\Windows\WindowsAI"; Name = "DisableAIDataAnalysis"; Value = 1; Desc = "Recall Snapshots (User)" },
        @{ Path = "HKCU:\SOFTWARE\Policies\Microsoft\Windows\WindowsAI"; Name = "DisableRecallDataProviders"; Value = 1; Desc = "Recall Providers" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsAI"; Name = "SetDenyAppListForRecall"; Value = @("Microsoft.MicrosoftEdge_8wekyb3d8bbwe!App", "Microsoft.WindowsTerminal_8wekyb3d8bbwe!App", "KeePassXC_8wekyb3d8bbwe!KeePassXC", "Microsoft.RemoteDesktop_8wekyb3d8bbwe!App"); Desc = "Recall App Deny List" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsAI"; Name = "SetDenyUriListForRecall"; Value = @("*.bank.*", "*.paypal.*", "*.bankofamerica.*", "mail.*", "webmail.*", "*password*", "*login*"); Desc = "Recall URI Deny List" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsAI"; Name = "SetMaximumStorageDurationForRecallSnapshots"; Value = 30; Desc = "Recall Max Retention (30 days)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsAI"; Name = "SetMaximumStorageSpaceForRecallSnapshots"; Value = 10; Desc = "Recall Max Storage (10 GB)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsAI"; Name = "TurnOffWindowsCopilot"; Value = 1; Desc = "Copilot Layer 1 (WindowsAI)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsCopilot"; Name = "TurnOffWindowsCopilot"; Value = 1; Desc = "Copilot Layer 2 (WindowsCopilot)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsCopilot"; Name = "ShowCopilotButton"; Value = 0; Desc = "Copilot Layer 3 (Taskbar)" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer"; Name = "DisableWindowsCopilot"; Value = 1; Desc = "Copilot Layer 4 (Explorer)" },
        @{ Path = "HKCU:\Software\Policies\Microsoft\Windows\WindowsCopilot"; Name = "TurnOffWindowsCopilot"; Value = 1; Desc = "Copilot User-scope" },
        @{ Path = "HKCU:\Software\Policies\Microsoft\Windows\WindowsCopilot"; Name = "ShowCopilotButton"; Value = 0; Desc = "Copilot Button (User)" },
        @{ Path = "HKCU:\Software\Policies\Microsoft\Windows\WindowsAI"; Name = "SetCopilotHardwareKey"; Value = "Microsoft.WindowsNotepad_8wekyb3d8bbwe!App"; Desc = "Copilot HW Key" },
        @{ Path = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsAI"; Name = "DisableClickToDo"; Value = 1; Desc = "Click to Do (Device)" },
        @{ Path = "HKCU:\SOFTWARE\Policies\Microsoft\Windows\WindowsAI"; Name = "DisableClickToDo"; Value = 1; Desc = "Click to Do (User)" },
        @{ Path = "HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\Paint"; Name = "DisableCocreator"; Value = 1; Desc = "Paint Cocreator" },
        @{ Path = "HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\Paint"; Name = "DisableGenerativeFill"; Value = 1; Desc = "Paint Gen Fill" },
        @{ Path = "HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\Paint"; Name = "DisableImageCreator"; Value = 1; Desc = "Paint Image Creator" },
        @{ Path = "HKLM:\SOFTWARE\Policies\WindowsNotepad"; Name = "DisableAIFeatures"; Value = 1; Desc = "Notepad AI" },
    ...
    foreach ($check in $checks) {
        ...
        if ($passed) {
            ...
            $antiAIPassed += [PSCustomObject]@{
                ...
                Path     = "$($check.Path)\$($check.Name)"
                Expected = $check.Value
                Actual   = if ($check.Value -is [array]) { ($check.Value -join ', ') } else { $check.Value }
            }
        }
        else {
            $results.Failed++
    ...
    Write-Host "  AntiAI: $($actualCheckCount - $antiAIFailed.Count)/$actualCheckCount verified" -ForegroundColor $(if ($antiAIFailed.Count -eq 0) { "Green" } else { "Yellow" })
}
catch {
    Write-Host "  ERROR: $_" -ForegroundColor Red
}

# [ALWAYS] EdgeHardening Configuration (20 policies)
$edgeStep = 8
Write-Host "[$edgeStep/$totalSteps] Verifying EdgeHardening Policies (20)..." -ForegroundColor Yellow
...
try {
    ...
    if (Test-Path $edgeConfigPath) {
        ...
        Write-Host "  EdgeHardening: Config not found - marking all 20 checks as FAILED" -ForegroundColor Yellow
        # CRITICAL: Must count all 20 checks as Failed when config missing!
        $results.Failed += 20
        $edgeFailed += [PSCustomObject]@{
            Policy   = "EdgeHardening (All 20 policies)"
...
try {
    ...
    $wpadCheck = @{ Path = "HKLM:\Software\Microsoft\Windows\CurrentVersion\Internet Settings\Wpad"; Name = "WpadOverride"; Expected = 1; Desc = "WPAD Disabled"; Optional = $false }
    ...
    try {
        $fingerRuleName = "NoID Privacy Pro - Block Finger Protocol (Port 79)"
    ...
    # NOTE: SRP rules are checked separately below due to random GUID naming
    $allAdvChecks = $rdpChecks + $wdigestCheck + $adminShareCheck + $tlsChecks + $wuChecks + $wpadCheck
    ...
    # Risky Ports checks owned by AdvancedSecurity (aggregate NetBIOS adapter + firewall state)
    ...
    $riskyPortsChecks = @(
        # NetBIOS adapter settings + Firewall rules (aggregate check)
        # Note: Individual firewall rule checks skipped due to performance (Get-NetFirewallRule too slow)
        @{ AggregateCheck = "NetBIOS_Adapters_Firewall"; Count = 14; Desc = "NetBIOS disabled on adapters + Firewall rules applied" }
    )
    
    foreach ($check in $riskyPortsChecks) {
        if ($check.RegistryPath) {
            # Registry check
            $actualValue = $null
            if (Test-Path $check.RegistryPath) {
                $actualValue = (Get-ItemProperty -Path $check.RegistryPath -Name $check.Name -ErrorAction SilentlyContinue).($check.Name)
            }
            ...
            if ($null -ne $actualValue -and $actualValue -eq $check.Expected) {
                ...
                $results.Failed++
                $advFailed += [PSCustomObject]@{ Setting = $check.Desc; Expected = $check.Expected; Actual = if ($null -eq $actualValue) { "Not set" } else { $actualValue } }
            }
        }
        elseif ($check.AggregateCheck -eq "NetBIOS_Adapters_Firewall") {
            # Check NetBIOS disabled on adapters (aggregate)
            try {
                ...
                # Count as passed if at least one adapter has NetBIOS disabled, or fail if none
                if ($disabledCount -gt 0) {
                    $results.Verified += $check.Count
                }
                else {
                    $results.Failed += $check.Count
                    $advFailed += [PSCustomObject]@{ Setting = $check.Desc; Expected = "Disabled on adapters"; Actual = "Not disabled" }
                }
            }
            catch {
                $results.Failed += $check.Count
                $advFailed += [PSCustomObject]@{ Setting = $check.Desc; Expected = "Disabled"; Actual = "Check failed" }
            }
        }
    }
    
    # Add to AllSettings for HTML report
    $advPassedCount = $results.AdvancedSecuritySettings - $advFailed.Count
    $results.AllSettings += [PSCustomObject]@{
        Category      = "AdvancedSecurity"
        Total         = $results.AdvancedSecuritySettings
        Passed        = $advPassedCount
    ...
    Write-Host "  AdvancedSecurity: $($results.AdvancedSecuritySettings - $advFailed.Count)/$($results.AdvancedSecuritySettings) verified" -ForegroundColor $(if ($advFailed.Count -eq 0) { "Green" } else { "Yellow" })
}
catch {
    Write-Host "  ERROR: $_" -ForegroundColor Red
}
...
$results.Verified = $results.TotalSettings - $results.Failed
...
<head>
    ...
    <title>NoID Privacy Pro - Complete Hardening Compliance Report</title>
    <style>
        :root {
    ...
    <div class="container">
        ...
        <div class="meta-info">
            ...
            <div class="meta-item">
                ...
                <span class="meta-value">NoID Privacy v2.1.0</span>
            </div>
        </div>
...
"@
        ...
        <div class="footer">
            <p>Generated by NoID Privacy Pro v2.1.0</p>
            <p>Open Source Security Hardening Framework</p>
        </div>
    </div>

...
(478 total registry keys modified across all modules)
...
|----------|-------|---------|
| **Security Settings** | 400+ | 478 reg keys (total across all modules) + 67 secedit settings + 25+ services + 19 ASR + 13 mitigations + 23 audit categories + more |
| **Privacy Settings** | 300+ | Included in 478 reg keys (110 telemetry-specific) + 37 permissions + 30 tasks + 9 AI + 80+ apps + more |
...
| **Registry Keys** | 478 | Security, Privacy, Network, Performance (see REGISTRY_KEYS.md) |

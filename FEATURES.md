...
- [Telemetry Control](#-telemetry-control) - 25+ Services, 392 Keys, 30 Tasks
...
(392 total registry keys modified across all modules)
...
| **Registry Keys** | 392 | Security, Privacy, Network, Performance (see REGISTRY_KEYS.md) |

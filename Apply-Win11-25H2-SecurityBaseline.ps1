...
.DESCRIPTION
    ...
    COMPLIANCE:
    - Microsoft Baseline 25H2: 100% (392 registry keys)
...
$modulePriority = @{
    ...
    'DNS-Common' = 8        # NEW: DNS Common helpers (MUST load before DNS-Providers!)
    'DNS-Providers' = 9     # NEW: Multi-Provider DNS (Cloudflare, AdGuard, NextDNS, Quad9)
    'DNS' = 10              # DNS Security (depends on DNS-Common + DNS-Providers!)
...
Write-Host "=============================================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "  Version: 1.7.17 | Modus: $Mode" -ForegroundColor Cyan
if ($Interactive) {

...
$Global:Strings = @{
    en = @{
        ...
        RemoteMenuOption1Desc4 = "Good for: typical desktop/laptop use, office work, browsing, most gaming scenarios"
        RemoteMenuOption1Pro = "Pro: Strong reduction of attack surface + RAM security (hibernate clears sensitive data from memory)"
        RemoteMenuOption1Con = "Con: No remote access, local servers/services may not work"
        RemoteMenuOption1Warning1 = "Note: Certain online multiplayer games that require inbound connections may NOT work."
        ...
        RemoteMenuOption2Desc3 = "Hibernate DISABLED - System stays ON 24/7 (prevents RDP disconnects, keeps services running)"
        RemoteMenuOption2Desc4 = "Use only if you explicitly need inbound connections (remote access, local servers, specific multiplayer setups)"
        RemoteMenuOption2Pro1 = "Pro: Remote access works; Docker/LLM/WSL and other local services remain fully functional"
        RemoteMenuOption2Pro2 = "Pro: Online multiplayer games that need inbound connections usually work more reliably"
        RemoteMenuOption2Pro3 = "Pro: No automatic sleep/hibernate (good for servers, NAS, always-on services)"
        RemoteMenuOption2Con = "Con: Larger attack surface (more inbound traffic allowed) + Higher power consumption"
        RemoteMenuRecommendation = "[Recommendation: If you are unsure, choose option 1. Use option 2 only if you explicitly need remote access/local services or if specific games stop working with option 1.]"
    ...
    de = @{
        ...
        RemoteMenuOption1Desc4 = "Geeignet fuer: typische Desktop-/Laptop-Nutzung, Buero, Surfen, die meisten Gaming-Szenarien"
        RemoteMenuOption1Pro = "Pro: Sehr starke Reduzierung der Angriffsflaeche + RAM-Sicherheit (Ruhezustand loescht sensible Daten aus Speicher)"
        RemoteMenuOption1Con = "Contra: Kein Remote-Zugriff, lokale Serverdienste funktionieren evtl. nicht"
        RemoteMenuOption1Warning1 = "Hinweis: Bestimmte Online-Multiplayer-Spiele, die eingehende Verbindungen benoetigen, funktionieren evtl. NICHT."
        ...
        RemoteMenuOption2Desc3 = "Ruhezustand DEAKTIVIERT - System bleibt 24/7 AN (verhindert RDP-Trennungen, haelt Dienste am Laufen)"
        RemoteMenuOption2Desc4 = "Nur nutzen, wenn bewusst eingehende Verbindungen benoetigt werden (Remote-Zugriff, lokale Server, spezielle Multiplayer-Setups)"
        RemoteMenuOption2Pro1 = "Pro: Remote-Zugriff funktioniert, Docker/LLM/WSL und andere lokale Dienste bleiben voll nutzbar"
        RemoteMenuOption2Pro2 = "Pro: Online Multiplayer-Spiele, die eingehende Verbindungen benoetigen, funktionieren in der Regel zuverlaessiger"
        RemoteMenuOption2Pro3 = "Pro: Kein automatischer Standby/Ruhezustand (gut fuer Server, NAS, Always-On-Dienste)"
        RemoteMenuOption2Con = "Contra: Groessere Angriffsflaeche (mehr eingehende Verbindungen moeglich) + Hoeherer Stromverbrauch"
        RemoteMenuRecommendation = "[Empfehlung: Wenn Sie unsicher sind, Option 1 waehlen. Option 2 nur nutzen, wenn Sie explizit Remote-Zugriff/lokale Dienste brauchen oder wenn bestimmte Spiele mit Option 1 nicht funktionieren.]"

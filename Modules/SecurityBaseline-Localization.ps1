...
$Global:Strings = @{
    en = @{
        ...
        RemoteMenuOption1Desc3 = "Good for: typical desktop/laptop use, office work, browsing, most gaming scenarios"
        RemoteMenuOption1Pro = "Pro: Strong reduction of attack surface"
        ...
        RemoteMenuOption2Desc3 = "Use only if you explicitly need inbound connections (remote access, local servers, specific multiplayer setups)"
        ...
        RemoteMenuOption2Con = "Con: Larger attack surface (more inbound traffic allowed)"
    ...
    de = @{
        ...
        RemoteMenuOption1Desc3 = "Geeignet fuer: typische Desktop-/Laptop-Nutzung, Buero, Surfen, die meisten Gaming-Szenarien"
        RemoteMenuOption1Pro = "Pro: Sehr starke Reduzierung der Angriffsflaeche"
        ...
        RemoteMenuOption2Desc3 = "Nur nutzen, wenn bewusst eingehende Verbindungen benoetigt werden (Remote-Zugriff, lokale Server, spezielle Multiplayer-Setups)"
        ...
        RemoteMenuOption2Con = "Contra: Groessere Angriffsflaeche (mehr eingehende Verbindungen moeglich)"

...
$Global:Strings = @{
    en = @{
        ...
        AuditModeStep1 = "1. All settings will be checked ONLY (no changes)"
        AuditModeStep2 = "2. ASR Rules will be activated in Audit mode:"
        AuditModeStep2a = "- Log events (what WOULD be blocked)"
        AuditModeStep2b = "- But block NOTHING"
        AuditModeStep2c = "- Microsoft Best Practice: First Audit, then Enforce!"
        AuditModeImportant = "IMPORTANT:"
        AuditModeImportantMsg = "Only ASR Rules will be activated (logging-only)."
        AuditModeUnchanged = "All other settings remain unchanged!"
        ...
        BackupIncludesHosts = "    - Hosts file (Windows default ~5 lines, without 80,101 domains blocklist)"
    ...
    de = @{
        ...
        AuditModeStep1 = "1. Alle Settings werden NUR geprueft (keine Aenderungen)"
        AuditModeStep2 = "2. ASR Rules werden im Audit-Modus aktiviert:"
        AuditModeStep2a = "- Loggen Ereignisse (was blockiert WUERDE)"
        AuditModeStep2b = "- Blockieren aber NICHTS"
        AuditModeStep2c = "- Microsoft Best Practice: Erst Audit, dann Enforce!"
        AuditModeImportant = "WICHTIG:"
        AuditModeImportantMsg = "Nur ASR Rules werden aktiviert (Logging-only)."
        AuditModeUnchanged = "Alle anderen Settings bleiben unveraendert!"
        ...
        BackupIncludesHosts = "    - Hosts-Datei (Windows-Default ~5 Zeilen, ohne 80.101 Domains Blocklist)"

...
$Global:Strings = @{
    en = @{
        ...
        RestoreExploitSuccess = "Exploit Protection: {0} mitigations restored"
        RestoreExploitAllFailed = "Exploit Protection: All mitigations failed (incompatible system?)"
        RestoreExploitNoMitigations = "Exploit Protection: No mitigations set (hardware incompatible)"
        ...
        RestoreDohSuccess = "{0} DoH servers restored (strict mode: registry=2, netsh=yes)"
    ...
    de = @{
        ...
        RestoreExploitSuccess = "Exploit Protection: {0} Mitigations wiederhergestellt"
        RestoreExploitAllFailed = "Exploit Protection: Alle Mitigations fehlgeschlagen (inkompatibles System?)"
        RestoreExploitNoMitigations = "Exploit Protection: Keine Mitigations gesetzt (Hardware inkompatibel)"
        ...
        RestoreDohSuccess = "{0} DoH Server wiederhergestellt (strict mode: registry=2, netsh=yes)"

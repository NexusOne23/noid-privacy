...
$Global:Strings = @{
    en = @{
        ...
        MainMenuAuditFollow = "-> DNS, OneDrive & Remote Access configuration follows"
        ...
        MainMenuCustomFollow = "-> ASR Mode, DNS, OneDrive & Remote Access configuration follows"
    ...
    de = @{
        ...
        MainMenuAuditFollow = "-> DNS, OneDrive & Remote-Access-Konfiguration folgt"
        ...
        MainMenuCustomFollow = "-> ASR-Modus, DNS, OneDrive & Remote-Access-Konfiguration folgt"

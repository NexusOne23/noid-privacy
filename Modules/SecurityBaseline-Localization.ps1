...
$Global:Strings = @{
    en = @{
        ...
        MainMenuAuditFollow = "-> DNS, RDP, Network & OneDrive config follows"
        MainMenuEnforce = "Enforce Mode"
        MainMenuEnforceDesc = "Apply EVERYTHING including ASR enforcement"
        MainMenuEnforceFollow = "-> DNS, RDP, Network & OneDrive config follows"
        MainMenuCustom = "Custom Mode"
        MainMenuCustomDesc = "Select modules individually"
        MainMenuCustomFollow = "-> ASR, DNS, RDP, Network & OneDrive config follows"
        ...
        EnforceBannerNetwork1 = "DNS over HTTPS (Choice: Cloudflare/AdGuard/NextDNS/Quad9 or Keep Current)"
        EnforceBannerNetwork2 = "DNS Blocklist (107,000+ Malware/Tracking/Phishing-Domains)"
        ...
        EnforceBannerNetwork5 = "Remote Access configurable (Desktop Mode=OFF, Remote Mode=ON)"
        ...
        EnforceBannerBloatware1 = "80+ bloatware apps removed (Xbox, Teams, Copilot, Candy Crush, etc.)"
        ...
        ModuleSelectionA = "[A]                    - Select ALL modules"
        ModuleSelectionN = "[N]                    - Select NONE (mandatory modules stay active)"
        ModuleSelectionEnter = "[ENTER]                - Confirm selection and start"
        ModuleSelectionEsc = "[ESC]                  - Return to main menu (without changes)"
        ModuleSelectionHint = "HINT:"
        ModuleSelectionMandatory = "YELLOW modules are mandatory and always active!"
        ModuleSelectionMandatoryTag = "[MANDATORY - CANNOT BE DISABLED]"
        
        # ISE Warning
        ISEWarningTitle = "WARNING: PowerShell ISE NOT SUPPORTED!"
        ISEWarningMessage = "Custom Mode requires arrow key navigation."
        ISEWarningNotWork = "This does NOT work in PowerShell ISE!"
        ISEWarningSolution = "SOLUTION:"
        ISEWarningStep1 = "1. Open a NORMAL PowerShell Console"
        ISEWarningStep2 = "2. Run the script there"
        ISEWarningAlternative = "Alternative: Use Audit/Enforce Mode (Option 1/2)"
        
        # Audit Mode
        AuditModeTitle = "Audit Mode"
        AuditModeBannerTitle = "AUDIT MODE - SAFE TEST MODE:"
        AuditModeWhatHappens = "What happens:"
        AuditModeStep1 = "1. Full security baseline will be applied (Core, Advanced, DNS, ...)"
        AuditModeStep2 = "2. ASR Rules run in AUDIT mode:"
        AuditModeStep2a = "- Events are logged"
        AuditModeStep2b = "- But NOT blocked"
        AuditModeStep2c = "- Microsoft Best Practice: First Audit, then Enforce!"
        AuditModeImportant = "IMPORTANT:"
        AuditModeImportantMsg = "Audit Mode affects ONLY ASR Rules."
        AuditModeUnchanged = "All other security settings are applied normally (ENFORCE)."
        AuditModeContinue = "Would you like to continue? [Y/N]:"
        
        # Custom Mode Summary
        CustomModeSummaryTitle = "Custom Mode"
        CustomModeSelectedModules = "Selected Modules:"
        CustomModeStep2 = "STEP 2: Choose mode for ASR rules:"
        CustomModeReady = "READY TO START!"
        CustomModeModuleCount = "Selected Modules: {0}"
        CustomModeASRMode = "ASR Mode: {0}"
        CustomModeWillStart = "The script will now start with your configuration."
        CustomModeStartNow = "Would you like to start NOW? [Y/N]:"
        CustomModeNoModules = "No modules selected!"
        
        # Verify Mode
        VerifyModeTitle = "Verify Mode"
        VerifyModeMessage = "Verify checks if the baseline was applied correctly."
        VerifyModeCall = "This calls the Verify script."
        VerifyModeContinue = "Would you like to continue? [Y/N]:"
        VerifyModeErrorPath = "[ERROR] Script path could not be determined (dot-sourced script?)"
        VerifyModeErrorRunManual = "Please run the Verify script directly."
        VerifyModeStarting = "[INFO] Starting Verify script..."
        VerifyModeComplete = "[OK] Verify script completed"
        VerifyModeErrorNotFound = "[ERROR] Verify script not found!"
        VerifyModeErrorExpected = "Expected: {0}"
        VerifyModeErrorRun = "[ERROR] Error running Verify script!"
        VerifyModeErrorDetails = "Details: {0}"
        
        # Safety Check
        SafetyCheckQuestion = "Have you read the README AND created a system backup?"
        SafetyCheckYes = "Yes, I have read everything and created a backup"
        SafetyCheckNo = "No, I will cancel"
        UserInputPrompt = "Your input"
        ...
        BackupFullCreating = "COMPLETE BACKUP BEING CREATED - 494 SETTINGS"
        BackupIncludes = "[i] Backup includes:"
        BackupIncludesDNS = "    - DNS Settings + DoH (usually Router-DNS, no DoH)"
        BackupIncludesHosts = "    - Hosts file (Windows default ~5 lines, without 107,772 domains blocklist)"
        BackupIncludesServices = "    - Services (25+ services that script modifies)"
        BackupIncludesFirewall = "    - Firewall (all rules + 3 profiles Domain/Private/Public)"
        BackupIncludesTasks = "    - Scheduled Tasks (30 tasks that script modifies)"
        BackupIncludesRegistry = "    - Registry (478 keys that script modifies)"
        BackupIncludesUsers = "    - Built-in Admin (name 'Administrator' + Enabled=$false)"
        BackupIncludesApps = "    - Installed Apps (list with names, NOT the apps themselves)"
        BackupIncludesASR = "    - ASR (19 rules) + Exploit Protection (13 mitigations)"
        ...
        DNSBlocklistInstalling = "Installing DNS Blocklist (107K+ Domains)..."
        ...
        DNSAntivirusInfo = "Antivirus software scans hosts file after installation (normal, temporary)"
        DNSAntivirusScanTime = "Scan completes in seconds to minutes depending on AV - no action needed"
        DNSAntivirusException = "If persistent issues: Add hosts to AV exceptions temporarily (not recommended long-term)"
        DNSAntivirusSecurity = "Important: hosts file SHOULD be scanned by AV for security!"
        ...
        # Bloatware Module
        BloatwareTitle = "Bloatware Removal (Conservative)"
        ...
        ConsumerFeaturesTitle = "Consumer Features (Auto-Install Bloatware)"
        ...
        SpecificAppsTitle = "Specific App Removal"
        ...
        CoreCFAActivated = "Controlled Folder Access activated (Ransomware Protection)"
        CoreCFAProtected = "Protected folders: Documents, Pictures, Videos, Desktop"
        CoreCFAWhitelist = "Can be disabled anytime via: Windows Security -> Virus & threat protection -> Ransomware protection"
        CoreCFAWhitelistApps = "Legitimate apps can be whitelisted in the same GUI location"
        ...
        AdvancedWDigestDisabling = "Disabling WDigest to prevent plaintext password storage in RAM..."
        AdvancedWDigestDisabled = "WDigest authentication disabled"
        AdvancedWDigestProtected = "Credentials are now protected from Mimikatz-style attacks"
        AdvancedWDigestNote = "NOTE: This blocks Digest authentication (rarely used, legacy protocol)"
        AdvancedEFSDisabling = "Disabling EFS RPC to prevent NTLM relay attacks..."
        AdvancedEFSDisabled = "EFS RPC disabled (auth coercion protection)"
        AdvancedEFSBitLockerOK = "BitLocker is NOT affected (different system)"
        AdvancedEFSNote = "NOTE: Legacy EFS encryption will not work (BitLocker recommended)"
        AdvancedWebClientDisabling = "Disabling WebClient service to prevent auth coercion attacks..."
        AdvancedWebClientStopped = "WebClient service stopped"
        AdvancedWebClientDisabled = "WebClient service disabled"
        AdvancedWebClientNotFound = "WebClient service not found (may not be installed)"
        AdvancedWebClientError = "Could not disable WebClient service: {0}"
        AdvancedWebClientRedirector = "WebDAV network redirector disabled"
        AdvancedWebClientCloudOK = "Modern cloud services (OneDrive, Dropbox, etc.) NOT affected"
        AdvancedWebClientNote = "NOTE: \\server\davwwwroot\ UNC paths will NOT work"
        
        # Telemetry Module - Services
        TelemetryServicesTitle = "Telemetry Services Deactivation"
        TelemetryServicesDisabling = "Telemetry services are being deactivated..."
        TelemetryServicesSkippedCritical = "SKIPPED: {0} (critical for Windows functions)"
        TelemetryServicesSkippedDependent = "SKIPPED: {0} (has {1} dependent services)"
        TelemetryServicesDependentService = "     Dependent service: {0}"
        TelemetryServicesCheckDependentFailed = "Could not check dependent services for {0}: {1}"
        TelemetryServicesDeactivated = "     Deactivated: {0}"
        TelemetryServicesError = "Error with {0}"
        TelemetryServicesDisabledCount = "{0} telemetry services deactivated"
        TelemetryServicesSkippedCount = "{0} critical services skipped (would break Windows)"
        
        # Telemetry Module - Registry
        TelemetryRegistryTitle = "Telemetry Registry Keys Configuration"
        TelemetryRegistrySetting = "Setting registry keys for privacy..."
        TelemetryPrivacyGeneralToggles = "Privacy | General: Deactivating all 5 toggles..."
        ...
        TelemetryTasksTitle = "Telemetry Scheduled Tasks Removal"
        TelemetryTasksDisabling = "Telemetry tasks are being deactivated..."
        TelemetryTasksDeactivated = "     Deactivated: {0}"
        TelemetryTasksAlreadyDisabled = "     Already disabled (skipped): {0}"
        TelemetryTasksError = "Error with {0}: {1}"
        TelemetryTasksDisabledCount = "{0} telemetry tasks deactivated"
        TelemetryTasksNotFoundCount = "{0} tasks not found (possibly already removed)"
        
        # Telemetry Module - Firewall/Hosts Blocking
        TelemetryHostsTitle = "Telemetry Hosts Blocking (Firewall)"
        TelemetryHostsSkipped = "Firewall blocking skipped (technical limitation)"
        TelemetryHostsReason = "REASON: Windows Firewall only accepts IP addresses, not hostnames"
        TelemetryHostsAlternative = "ALTERNATIVE: Telemetry blocked via Registry + Services (already active)"
        TelemetryHostsBlocking = "Blocking telemetry endpoints..."
        TelemetryHostsBlocked = "Telemetry hosts blocked ({0} endpoints in {1} rules)"
        TelemetryHostsWindowsUpdateOK = "Windows Update continues to work normally!"
        TelemetryHostsNoRules = "No telemetry firewall rules could be created"
        TelemetryHostsRuleError = "Error creating firewall rule {0}: {1}"
        
        # Telemetry Module - Status Report
        TelemetryStatusTitle = "Telemetry Status Report"
        TelemetryStatusCreating = "Creating telemetry status report..."
        TelemetryStatusDeactivated = "\n=== DEACTIVATED ([OK]) ==="
        TelemetryStatusDiagTrack = "[OK] DiagTrack Service (Connected User Experiences)"
        TelemetryStatusWAPPush = "[OK] dmwappushservice (WAP Push Routing)"
        TelemetryStatusErrorReporting = "[OK] WerSvc (Windows Error Reporting)"
        TelemetryStatusRegistry = "[OK] Telemetry Registry (AllowTelemetry = 0)"
        TelemetryStatusAppTelemetry = "[OK] Application Telemetry"
        TelemetryStatusAdvertisingID = "[OK] Advertising ID"
        TelemetryStatusActivityHistory = "[OK] Activity History / Timeline"
        TelemetryStatusCloudClipboard = "[OK] Cloud Clipboard"
        TelemetryStatusLocationServices = "[OK] Location Services"
        TelemetryStatusHandwriting = "[OK] Handwriting Data Collection"
        TelemetryStatusSettingsSync = "[OK] Settings Sync"
        TelemetryStatusFindMyDevice = "[OK] Find My Device"
        TelemetryStatusWindowsTips = "[OK] Windows Tips"
        TelemetryStatusTailoredExp = "[OK] Tailored Experiences"
        TelemetryStatusConsumerFeatures = "[OK] Consumer Features (Auto-Install Apps)"
        TelemetryStatusScheduledTasks = "[OK] ~14 Telemetry Scheduled Tasks"
        TelemetryStatusFirewallHosts = "[OK] ~45 Telemetry Hosts (Firewall)"
        TelemetryStatusNotDeactivated = "\n=== NOT DEACTIVATED ([!]) - WHY? ==="
        TelemetryStatusWindowsUpdate = "[!] Windows Update Service"
        TelemetryStatusUpdateReason = "      REASON: Critical for security updates!"
        TelemetryStatusUpdateWithout = "      Without it: NO Windows/Defender updates!"
        TelemetryStatusDiagPolicy = "[!] Diagnostic Policy Service (DPS)"
        TelemetryStatusDiagPolicyReason = "      REASON: Windows Troubleshooter needs this!"
        TelemetryStatusDiagPolicyWithout = "      Without it: Troubleshooting won't work!"
        TelemetryStatusDiagSystemHost = "[!] Diagnostic System Host (WdiSystemHost)"
        TelemetryStatusDiagSystemReason = "      REASON: System diagnostics (e.g. disk check)"
        TelemetryStatusDiagSystemWithout = "      Without it: No hardware diagnostics possible!"
        TelemetryStatusMinimalTelemetry = "[!] Minimal Telemetry (Security Level = 0)"
        TelemetryStatusMinimalReason = "      REASON: Windows Update + Defender need basic telemetry!"
        TelemetryStatusMinimalWhat = "      WHAT IS SENT: Only critical security events"
        TelemetryStatusMinimalNot = "      NOT sent: Usage data, app lists, browsing, etc."
        TelemetryStatusResult = "\n=== RESULT ==="
        TelemetryStatus95Percent = "[OK] ~95% telemetry deactivated"
        TelemetryStatusOnlySecurity = "[OK] Only security-critical basic telemetry active"
        TelemetryStatusNoTracking = "[OK] NO usage data, advertising, tracking"
        TelemetryStatusUpdateWorks = "[OK] Windows Update + Defender work!"
        TelemetryStatusMaxPrivacy = "[OK] Maximum Privacy WITHOUT loss of functionality!"
        
        # Telemetry Module - Windows Search Web Features
        TelemetrySearchTitle = "Windows Search - Web Features Deactivation"
        TelemetrySearchSettingUser = "Setting user-level web search settings (HKCU)..."
        TelemetrySearchComplete = "Windows Search: Local only, NO web/Bing/cloud!"
        TelemetrySearchNoWebResults = "Start Menu Search shows NO web results anymore"
        
        # Telemetry Module - Camera and Microphone
        TelemetryCameraTitle = "Camera and Microphone - APP PERMISSIONS Removal"
        TelemetryCameraRemoving = "Removing camera and microphone permissions for ALL apps..."
        TelemetryCameraHKCUValue = "     Camera HKCU: Value=Deny"
        TelemetryCameraAppError = "     Camera App '{0}' error: {1}"
        TelemetryCameraAppsEnumError = "Camera apps enumeration error (not critical): {0}"
        TelemetryCameraHKCUError = "Camera HKCU error: {0}"
        TelemetryCameraHKLMValue = "     Camera HKLM: Value=Deny"
        TelemetryCameraHKLMError = "Camera HKLM error: {0}"
        TelemetryMicrophoneHKCUValue = "     Microphone HKCU: Value=Deny"
        TelemetryMicrophoneAppError = "     Microphone App '{0}' error: {1}"
        TelemetryMicrophoneAppsEnumError = "Microphone apps enumeration error (not critical): {0}"
        TelemetryMicrophoneHKCUError = "Microphone HKCU error: {0}"
        TelemetryMicrophoneHKLMValue = "     Microphone HKLM: Value=Deny"
        TelemetryMicrophoneHKLMError = "Microphone HKLM error: {0}"
        TelemetryDeviceTogglesSet = "Setting device-level toggles (camera/microphone access)..."
        TelemetryCameraDeviceToggle = "     Device-Toggle Camera: {0} = OFF"
        TelemetryCameraDeviceError = "Camera device-level toggle error: {0}"
        TelemetryMicrophoneDeviceToggle = "     Device-Toggle Microphone: {0} = OFF"
        TelemetryMicrophoneDeviceError = "Microphone device-level toggle error: {0}"
        TelemetryDeviceTogglesComplete = "Device-level toggles set - 'Camera/Microphone access' should now be OFF"
        TelemetryCameraAllDisabled = "Camera: ALL standard apps deactivated (User must consent per app)"
        TelemetryCameraConsentStore = "Camera ConsentStore: '{0}' (expected: Deny)"
        TelemetryMicrophoneAllDisabled = "Microphone: ALL standard apps deactivated (User must consent per app)"
        TelemetryMicrophoneConsentStore = "Microphone ConsentStore: '{0}' (expected: Deny)"
        TelemetryStopSettingsApp = "Stopping Settings app so changes become immediately visible..."
        TelemetrySettingsAppRestarted = "     Settings app was restarted"
        TelemetrySettingsAppNotOpen = "Settings app was not open - OK"
        TelemetryFlushRegistryCache = "Flushing registry cache..."
        TelemetryRegistryCacheFlushed = "     Registry cache flushed"
        TelemetryRegistryCacheOptional = "Registry cache flush optional"
        TelemetryImportantChangeSeparator = "========================================"
        TelemetryImportantWin11Change = "IMPORTANT: WINDOWS 11 24H2/25H2 CHANGE!"
        TelemetrySQLiteChange = "Starting Windows 11 24H2/25H2, Windows uses an SQLite database for privacy settings!"
        TelemetryStandardAppsDisabled = "This script has deactivated all STANDARD APPS - works:"
        TelemetryAppsNeedPermission = "  - Apps need YOUR PERMISSION for camera/microphone access"
        TelemetryWindowsAsksFirst = "  - On first access Windows asks: 'May [App] access?'"
        TelemetryUserCanAllow = "  - You can then click Allow or Deny"
        TelemetryMasterTogglesManual = "BUT: The MASTER TOGGLES in Settings can ONLY be changed MANUALLY!"
        TelemetryRecommendedManual = "RECOMMENDED: Turn off the master toggles manually:"
        TelemetryOpenSettings = "  1. Open: Settings (Windows Key + I)"
        TelemetryCameraSettings = "  2. Go to: Privacy and security | Camera"
        TelemetryCameraAccessOff = "  3. Turn OFF: 'Camera access' (top toggle)"
        TelemetryCameraAppsOff = "  4. Turn OFF: 'Let apps access your camera' (second toggle)"
        TelemetryMicrophoneSettings = "  5. Go to: Privacy and security | Microphone"
        TelemetryMicrophoneAccessOff = "  6. Turn OFF: 'Microphone access' (top toggle)"
        TelemetryMicrophoneAppsOff = "  7. Turn OFF: 'Let apps access your microphone' (second toggle)"
        TelemetryResultMaxPrivacy = "RESULT: Maximum privacy + You retain full control!"
        TelemetryCanAllowIndividual = "You can allow individual apps in Settings anytime."
        TelemetryHardwareInfo = "HARDWARE INFO: Physical camera/microphone devices remain active"
        TelemetryHardwareDisable = "To disable hardware: Device Manager | Camera/Audio | Right-click | Disable"
        
        # Telemetry Module - Privacy Experience Settings
        TelemetryPrivacyExpTitle = "Privacy Experience Settings Deactivation"
        TelemetryPrivacyExpComplete = "Privacy Experience: Suggested content deactivated"
        
        # Telemetry Module - Inking and Typing Personalization
        TelemetryInkingTitle = "Handwriting and Typing Personalization Deactivation"
        TelemetryInkingSettingUser = "Setting user-level inking and typing settings (HKCU)..."
        TelemetryInkingComplete = "Handwriting and Typing Personalization: NO data collection"
        TelemetryInkingSettingsOff = "Settings | Privacy and security | Inking and typing personalization is now OFF"
        
        # Telemetry Module - Location Services
        TelemetryLocationTitle = "Location Services Deactivation"
        TelemetryLocationSettingHKCU = "Setting location also for current user (HKCU)..."
        TelemetryLocationHKCUValue = "     Location HKCU: Value=Deny"
        TelemetryLocationAppError = "     Location App '{0}' error: {1}"
        TelemetryLocationAppsEnumError = "Location apps enumeration error (not critical): {0}"
        TelemetryLocationHKCUError = "Location HKCU error: {0}"
        TelemetryLocationComplete = "Location: Standard apps deactivated (User must consent per app)"
        TelemetryLocationMasterToggle = "Master toggle must be manually turned off in Settings (Privacy | Location) (25H2)"
        
        # Telemetry Module - App Permissions (All 34 Permissions)
        TelemetryAppPermTitle = "App Permissions - Privacy by Default (Complete)"
        TelemetryAppPermSetting = "Setting ALL app permissions to OFF (User can activate individually)..."
        TelemetryAppPermVerboseSpeech = "Speech Recognition OFF..."
        TelemetryAppPermVerboseNotif = "Notifications Access OFF..."
        TelemetryAppPermVerboseAccount = "Account Info Access OFF..."
        TelemetryAppPermVerboseContacts = "Contacts Access OFF..."
        TelemetryAppPermVerboseCalendar = "Calendar Access OFF..."
        TelemetryAppPermVerboseEmail = "Email Access OFF..."
        TelemetryAppPermVerbosePhone = "Phone Calls Access OFF..."
        TelemetryAppPermVerboseCallHistory = "Call History Access OFF..."
        TelemetryAppPermVerboseMessaging = "Messaging Access OFF..."
        TelemetryAppPermVerboseTasks = "Tasks Access OFF..."
        TelemetryAppPermVerboseRadios = "Radios Control OFF..."
        TelemetryAppPermVerboseDevices = "Other Devices Sync OFF..."
        TelemetryAppPermVerboseVoice = "Voice Activation OFF..."
        TelemetryAppPermVerboseDocs = "Documents Library Access OFF..."
        TelemetryAppPermVerbosePics = "Pictures Library Access OFF..."
        TelemetryAppPermVerboseVideos = "Videos Library Access OFF..."
        TelemetryAppPermVerboseBroadFS = "Broad File System Access OFF..."
        TelemetryAppPermVerboseDownloads = "Downloads Folder Access OFF..."
        TelemetryAppPermVerboseMusic = "Music Library Access OFF..."
        TelemetryAppPermVerboseAutoDownloads = "Automatic File Downloads OFF..."
        TelemetryAppPermVerboseAppDiag = "App Diagnostics OFF..."
        TelemetryAppPermVerboseActivity = "Activity History Access OFF..."
        TelemetryAppPermVerboseBluetooth = "Bluetooth Access OFF..."
        TelemetryAppPermVerboseCellular = "Cellular Data Access OFF..."
        TelemetryAppPermVerboseGaze = "Gaze Input (Eye Tracking) OFF..."
        TelemetryAppPermVerboseGraphicsProg = "Graphics Capture (Programmatic) OFF..."
        TelemetryAppPermVerboseGraphicsBorder = "Graphics Capture (Without Border) OFF..."
        TelemetryAppPermVerboseHID = "Human Interface Device Access OFF..."
        TelemetryAppPermVerbosePasskeys = "Passkeys Access OFF..."
        TelemetryAppPermVerbosePasskeysEnum = "Passkeys Enumeration OFF..."
        TelemetryAppPermVerboseSensors = "Custom Sensors Access OFF..."
        TelemetryAppPermVerboseSerial = "Serial Communication Access OFF..."
        TelemetryAppPermVerboseAI = "System AI Models Access OFF..."
        TelemetryAppPermVerboseUSB = "USB Device Access OFF..."
        TelemetryAppPermVerboseWiFiData = "WiFi Data Access OFF..."
        TelemetryAppPermVerboseWiFiDirect = "WiFi Direct Access OFF..."
        TelemetryAppPermSettingHKCU = "Setting permissions also for CURRENT user (HKCU)..."
        TelemetryAppPermHKCUDeny = "     HKCU: {0} = Deny"
        TelemetryAppPermAppError = "     App '{0}' error: {1}"
        TelemetryAppPermAppsEnumError = "Permission '{0}' apps enumeration error (not critical): {1}"
        TelemetryAppPermHKCUError = "HKCU Permission '{0}' error: {1}"
        TelemetryAppPermStoppingSettings = "Stopping Settings App so changes take effect immediately..."
        TelemetryAppPermSettingsStopped = "     Settings App successfully stopped"
        TelemetryAppPermSettingsNotStopped = "Settings App could not be terminated"
        TelemetryAppPermSettingsStopFailed = "Settings App stop failed: {0}"
        TelemetryAppPermComplete = "App Permissions: ALL 33 categories - standard apps deactivated!"
        TelemetryAppPermNeedConsent = "Apps need YOUR PERMISSION for data access!"
        TelemetryAppPermSQLiteInfo = "Starting Windows 11 24H2/25H2, Windows uses an SQLite database for privacy settings!"
        TelemetryAppPermStandardDisabled = "This script has deactivated all STANDARD APPS for:"
        TelemetryAppPermCategories = "  - Notifications, Contacts, Calendar, Email, Messages"
        TelemetryAppPermMoreCategories = "  - Account Info, Phone Calls, Documents, Pictures, Videos"
        TelemetryAppPermEvenMore = "  - Location, Bluetooth, WiFi, USB, and 20+ more"
        TelemetryAppPermDefaultPrivacy = "Privacy by Default: Apps need YOUR PERMISSION!"
        TelemetryAppPermFirstAccess = "  - On first access Windows asks: 'May [App] access?'"
        TelemetryAppPermCanDeny = "  - You can then click Allow or Deny"
        TelemetryAppPermTogglesManual = "BUT: The MASTER TOGGLES in Settings can ONLY be changed MANUALLY!"
        TelemetryAppPermOptionalManual = "OPTIONAL: You can manually turn off the master toggles:"
        TelemetryAppPermOpenSettings = "  1. Open: Settings (Windows Key + I) | Privacy and security"
        TelemetryAppPermGoThrough = "  2. Go through all categories (Notifications, Contacts, etc.)"
        TelemetryAppPermTurnOffTop = "  3. Turn OFF the top toggle in each category"
        TelemetryAppPermTipOptional = "TIP: This is OPTIONAL! Even without toggle changes:"
        TelemetryAppPermNoAccessUntil = "  - Apps have no access until you allow"
        TelemetryAppPermGuaranteed = "  - Privacy is guaranteed!"
        TelemetryAppPermResultControl = "RESULT: Privacy + You retain full control!"
        
        # Telemetry Module - Game Bar and Game Mode
        TelemetryGameBarTitle = "Xbox Game Bar and Game Mode Deactivation"
        TelemetryGameBarComplete = "Xbox Game Bar and Game Mode deactivated"
        TelemetryGameBarWindowsKeyG = "Windows Key + G now opens NOTHING anymore"
        TelemetryGameBarAutoMode = "Game Mode will NOT be activated automatically"
        
        # Telemetry Module - Lock Screen Security
        TelemetryLockScreenTitle = "Lock Screen Security Hardening"
        TelemetryLockScreenComplete = "Lock screen hardened: No camera, no slideshow, no toast notifications"
        ...
        EdgeSyncPrivacyConfig = "Configuring Edge Sync & Privacy (Microsoft Account Data Collection Block)..."
        EdgeSyncDisabled = "Edge Sync DISABLED - No data upload to Microsoft Account!"
        EdgeSearchSuggestDisabled = "Search Suggestions DISABLED - No queries to Bing!"
        EdgeNoDataToMS = "Edge will NO LONGER send browsing data to Microsoft!"
        EdgeMSAccountWarningTitle = "  [!] IMPORTANT: Microsoft Account Users"
        EdgeMSAccountWarningText = "  If you are signed in to Edge with a Microsoft Account:"
        EdgeMSAccountStep1 = "    1. Open Edge -> Settings -> Profiles"
        EdgeMSAccountStep2 = "    2. Click 'Turn off sync' (despite policy)"
        EdgeMSAccountStep3 = "    3. Delete already synced data in your Microsoft Account:"
        EdgeMSAccountURL = "       https://account.microsoft.com/privacy/activity-history"
        EdgeMSAccountStep4 = "    4. RESTART Edge for full effect!"
        ...
        EdgeSecurityBalanced = "  [OK] Enhanced Security: Balanced"
        ...
        BackupServicesNote = "[i] This allows 100% restore"
        BackupFirewall = "Firewall rules being backed up..."
        BackupFirewallSaved = "Firewall rules backed up (ALL!)"
        BackupFirewallNote = "[i] Incl. all standard rules status"
        ...
        BackupSecurityTemplate = "[11/15] Security Template (secedit)..."
        ...
        BackupNote = "[!] To restore: Run script again and select 'Restore' from menu."
        ...
        BackupScheduledTasksNote = "[i] Only State (Enabled/Disabled/Ready) is backed up"
        ...
        AppListFileIntro = "These apps were removed by the Security Baseline script`r`nand need to be manually reinstalled from Microsoft Store:"
        ...
        AppListFileNote = "NOTE: Some apps may not be available in your region`r`n      or may have been discontinued by Microsoft."
        ...
        RestoreRebootCountdown = "{0} seconds..."
        
        # Restore - Additional Missing Strings
        RestoreNoTasksInBackup = "No Scheduled Tasks in backup"
        RestorePasswordCopied = "Password copied to clipboard!"
        RestorePasswordPasteNow = "Please paste into password manager NOW!"
        RestorePasswordClearIn30 = "Clipboard will be cleared in 30 seconds!"
        RestorePasswordClipboardFailed = "Clipboard not available - password shown below:"
        RestorePasswordWait30 = "Waiting 30 seconds before clearing clipboard..."
        RestorePasswordSecondsLeft = "{0} seconds remaining..."
        RestorePasswordCleared = "Clipboard cleared (security)"
        RestoreASRSuccess = "{0} ASR Rules restored"
        RestoreASRNotAvailable = "Set-MpPreference not available"
        RestoreASRFailed = "ASR Rules restore failed:"
        RestoreASRNoBackup = "No ASR Rules in backup"
        RestoreExploitNotAvailable = "Set-ProcessMitigation not available (Windows 10 1709+ required)"
        RestoreExploitSuccess = "Exploit Protection: {0} mitigations restored from backup"
        RestoreExploitAllFailed = "Exploit Protection: All mitigations failed (incompatible system?)"
        RestoreExploitNoMitigations = "Exploit Protection: No mitigations in backup (none were enabled originally)"
        RestoreExploitFailed = "Exploit Protection restore failed:"
        RestoreExploitNoBackup = "No Exploit Protection in backup (or not activated)"
        RestoreDohSuccess = "DoH configuration restored from backup ({0} servers)"
        RestoreDohNoServers = "No DoH servers restored"
        RestoreDohFailed = "DoH restore failed:"
        RestoreDohNoBackup = "No DoH configuration in backup"
        RestoreDohRemoved = "DoH configuration removed (backup had none)"
        RestoreDohEncryptionSuccess = "DoH Encryption: {0} adapters, {1} DNS servers restored"
        RestoreDohEncryptionNoServers = "No DoH Encryption Preferences restored"
        RestoreDohEncryptionFailed = "DoH Encryption Preferences restore failed:"
        RestoreDohEncryptionNoBackup = "No DoH Encryption Preferences in backup"
        RestoreFirewallProfileSuccess = "Firewall Profile '{0}' restored"
        RestoreFirewallProfileFailed = "Firewall Profile '{0}' could not be restored:"
        RestoreFirewallProfilesSuccess = "{0} Firewall Profiles restored"
        RestoreFirewallProfilesError = "Firewall Profile restore failed:"
        RestoreFirewallProfilesNoBackup = "No Firewall Profiles in backup"
        RestoreDeviceAppFailed = "Device-Level App '{0}' could not be restored:"
        RestoreDeviceAppSuccess = "{0} Device-Level Apps restored, {1} deleted"
        RestoreDeviceAppNoChanges = "No device-level apps needed restoration"
        RestoreDeviceAppError = "Device-Level App restore failed:"
        
        # OneDrive Menu
        OneDriveMenuTitle = "ONEDRIVE HANDLING"
        OneDriveMenuQuestion = "How should OneDrive be configured?"
        OneDriveMenuOption1 = "Privacy Hardening (Recommended)"
        OneDriveMenuOption1Desc1 = "Blocks telemetry and automatic uploads"
        OneDriveMenuOption1Desc2 = "OneDrive stays functional for manual use"
        OneDriveMenuOption1Desc3 = "You keep full control over what gets synced"
        OneDriveMenuOption2 = "Complete Removal (Advanced)"
        OneDriveMenuOption2Desc1 = "Uninstalls OneDrive completely"
        OneDriveMenuOption2Warning = "WARNING: CANNOT be restored from backup!"
        OneDriveMenuOption2Desc2 = "Your OneDrive folder and files stay safe"
        OneDriveMenuOption2Desc3 = "Can be reinstalled manually if needed"
        OneDriveMenuOption3 = "Skip (No changes)"
        OneDriveMenuOption3Desc = "OneDrive stays as-is"
        OneDriveMenuPrompt = "Your choice (1-3)"
        
        # Remote Access Menu
        RemoteMenuTitle = "REMOTE ACCESS & FIREWALL CONFIGURATION"
        RemoteMenuQuestion = "Do you use Remote Desktop (RDP) or run local services?"
        RemoteMenuExamples = "Examples:"
        RemoteMenuExample1 = "Remote access via RDP, TeamViewer, or Tailscale"
        RemoteMenuExample2 = "Docker containers with inter-container communication"
        RemoteMenuExample3 = "Local AI/LLM services (OpenWebUI, Ollama, etc.)"
        RemoteMenuExample4 = "Development servers (Node, Python, WSL)"
        RemoteMenuExample5 = "Online multiplayer games that require inbound connections (hosting, some P2P titles)"
        RemoteMenuOption1 = "Maximum Security (Default recommendation)"
        RemoteMenuOption1Desc1 = "RDP completely DISABLED"
        RemoteMenuOption1Desc2 = "Firewall blocks ALL inbound traffic (including 'allowed apps')"
        RemoteMenuOption1Desc3 = "Hibernate ENABLED (30 min) - RAM written to BitLocker-encrypted disk (Cold Boot Attack protection)"
        RemoteMenuOption1Desc4 = "Good for: desktop/laptop, office, browsing, most games"
        RemoteMenuOption1Pro = "Pro: Strong attack surface reduction + RAM security (hibernate clears sensitive data)"
        RemoteMenuOption1Con = "Con: No remote access, local servers/services may not work"
        RemoteMenuOption1Warning1 = "Note: Multiplayer games requiring inbound connections may NOT work."
        RemoteMenuOption1Warning2 = "(for example when you host games yourself or use peer-to-peer modes)"
        RemoteMenuOption2 = "Allow Remote Access + Local Services (less strict)"
        RemoteMenuOption2Desc1 = "RDP stays ENABLED (for Tailscale/VPN/remote administration)"
        RemoteMenuOption2Desc2 = "Firewall allows localhost and rule-based inbound connections"
        RemoteMenuOption2Desc3 = "Hibernate OFF - System stays ON 24/7 (no RDP disconnects, services run)"
        RemoteMenuOption2Desc4 = "Use only if you need remote access/local servers/multiplayer"
        RemoteMenuOption2Pro1 = "Pro: Remote access + Docker/LLM/WSL remain fully functional"
        ...
        RemoteMenuRecommendation = "[Recommendation: If unsure, choose option 1.`n                   Use option 2 only for remote access/services or if games fail.]"
        RemoteMenuPrompt = "Your choice (1-2)"
        
        # Network Discovery Menu
        NetworkMenuTitle = "NETWORK DISCOVERY & DEVICE COMMUNICATION"
        NetworkMenuQuestion = "How do you use your network and smart devices?"
        NetworkMenuOption1 = "Maximum Security (Stealth Mode)"
        NetworkMenuOption1Baseline = "Microsoft Baseline: NetBIOS disabled"
        NetworkMenuOption1Extra1 = "+ EXTRA Security: LLMNR disabled"
        NetworkMenuOption1Extra2 = "+ EXTRA Security: mDNS disabled"
        NetworkMenuOption1Extra3 = "+ EXTRA Security: Network Discovery disabled"
        NetworkMenuOption1Extra4 = "+ EXTRA Security: WSD/SSDP disabled"
        NetworkMenuOption1Pro1 = "Pro: Maximum network security (invisible on network)"
        NetworkMenuOption1Pro2 = "Pro: Zero name resolution spoofing possible"
        NetworkMenuOption1Pro3 = "Pro: No automatic device discovery (attack surface minimized)"
        NetworkMenuOption1Con1 = "Con: No Chromecast/Smart TV discovery"
        NetworkMenuOption1Con2 = "Con: No Miracast/Wireless Display"
        NetworkMenuOption1Con3 = "Con: No AirPlay"
        NetworkMenuOption1Con4 = "Con: No automatic printer discovery"
        NetworkMenuOption1Con5 = "Con: No Explorer network browsing (\\PC-NAME broken)"
        NetworkMenuOption1Con6 = "Con: Manual IP addresses required (\\192.168.1.100\share)"
        NetworkMenuOption1Recommended = "Recommended for: Enterprises, Public WiFi, Maximum Privacy"
        NetworkMenuOption2 = "Home User (Modern Protocols Only)"
        NetworkMenuOption2Baseline = "Microsoft Baseline: NetBIOS disabled"
        NetworkMenuOption2BestPractice = "Best Practice: LLMNR disabled"
        NetworkMenuOption2Modern = "Modern Standard: mDNS ENABLED"
        NetworkMenuOption2Convenience1 = "Home Convenience: Network Discovery ENABLED"
        NetworkMenuOption2Convenience2 = "Printer Discovery: WSD/SSDP ENABLED"
        NetworkMenuOption2Pro1 = "Pro: Legacy exploits blocked (NetBIOS, LLMNR)"
        NetworkMenuOption2Pro2 = "Pro: Chromecast/Smart TV works"
        NetworkMenuOption2Pro3 = "Pro: Miracast/Wireless Display works"
        NetworkMenuOption2Pro4 = "Pro: AirPlay works"
        NetworkMenuOption2Pro5 = "Pro: Printer auto-discovery works"
        NetworkMenuOption2Pro6 = "Pro: Network browsing works (with DNS/IP fallback)"
        NetworkMenuOption2Note1 = "Note: Still very secure (only modern protocols allowed)"
        NetworkMenuOption2Note2 = "Note: mDNS is harder to spoof than NetBIOS/LLMNR"
        NetworkMenuOption2Recommended = "Recommended for: Home networks, Smart Home users, Gamers"
        NetworkMenuInfo1 = "Microsoft Security Baseline 25H2 only requires NetBIOS disabled."
        NetworkMenuInfo2 = "Option 2 exceeds MS baseline while maintaining home convenience."
        NetworkMenuPrompt = "Your choice (1-2)"
        
        # VBS/Credential Guard POST-REBOOT Verification
        VBSPostRebootTitle = "[!] POST-REBOOT VERIFICATION REQUIRED:"
        VBSPostRebootDesc = "After reboot, verify that VBS/Credential Guard are ACTUALLY running:"
        VBSPostRebootCommand = "PowerShell Command:"
        VBSPostRebootExpected = "Expected Output: 1 or 2 (Credential Guard running)"
        VBSPostRebootFailed = "If Output is empty or 0: VBS/Credential Guard FAILED to start!"
        VBSPostRebootCauses = "Common Causes of Failure:"
        VBSPostRebootCause1 = "- TPM 2.0 not present or not enabled"
        VBSPostRebootCause2 = "- Virtualization disabled in BIOS/UEFI"
        VBSPostRebootCause3 = "- Incompatible CPU (Intel <8th Gen, AMD <Ryzen 2000)"
        VBSPostRebootCause4 = "- Incompatible Hypervisor (VMware, VirtualBox without nested VT)"
        
        # BitLocker NOT ACTIVE Warning
        BitLockerNotActiveTitle = "!!! CRITICAL: BITLOCKER IS NOT ACTIVE !!!"
        BitLockerNotActiveLine1 = "Policies are configured, but BitLocker is NOT enabled!"
        BitLockerNotActiveLine2 = "Your drive is NOT encrypted - data can be stolen if device is lost!"
        BitLockerNotActiveMustEnable = "YOU MUST MANUALLY ENABLE BITLOCKER:"
        BitLockerNotActiveOption1 = "Option 1: Control Panel"
        BitLockerNotActiveOption1Step1 = "1. Open Control Panel"
        BitLockerNotActiveOption1Step2 = "2. Navigate to: System and Security -> BitLocker Drive Encryption"
        BitLockerNotActiveOption1Step3 = "3. Click 'Turn on BitLocker' for C: drive"
        BitLockerNotActiveOption1Step4 = "4. Save Recovery Key to Microsoft Account (recommended)"
        BitLockerNotActiveOption2 = "Option 2: PowerShell (requires admin)"
        BitLockerNotActiveOption2Cmd = 'Enable-BitLocker -MountPoint "C:" -EncryptionMethod XtsAes256'
        BitLockerNotActiveFooter = "!!! WITHOUT BITLOCKER ENABLED, YOUR DATA IS NOT ENCRYPTED !!!"
        
        # BitLocker AES-256 Upgrade Instructions
        BitLockerUpgradeTitle = "HOW TO UPGRADE TO AES-256 (IN WINDOWS):"
        BitLockerUpgradeMethod1 = "METHOD 1 - Windows Start Menu (EASIEST):"
        BitLockerUpgradeMethod1Step1 = "1. Press Windows key"
        BitLockerUpgradeMethod1Step2 = "2. Type: BitLocker manage"
        BitLockerUpgradeMethod1Step3 = "3. Press Enter"
        BitLockerUpgradeMethod1Step4 = "4. Click on 'Disable BitLocker'"
        BitLockerUpgradeMethod1Step4Warn = "(WARNING: Takes 30-90 min!)"
        BitLockerUpgradeMethod1Step5 = "5. Wait until 'BitLocker disabled' is shown"
        BitLockerUpgradeMethod1Step6 = "6. Click on 'Enable BitLocker'"
        BitLockerUpgradeMethod1Step6Info = "(Our Policy applies = AES-256!)"
        BitLockerUpgradeMethod1Step7 = "7. <IMPORTANT> SAVE Recovery Key (MS Account recommended)"
        BitLockerUpgradeMethod2 = "METHOD 2 - Control Panel:"
        BitLockerUpgradeMethod2Step1 = "1. Open Control Panel"
        BitLockerUpgradeMethod2Step2 = "2. System and Security"
        BitLockerUpgradeMethod2Step3 = "3. BitLocker Drive Encryption"
        BitLockerUpgradeMethod2Step4 = "4. Continue as Method 1 (Steps 4-7)"
        BitLockerUpgradeMethod3 = "METHOD 3 - File Explorer:"
        BitLockerUpgradeMethod3Step1 = "1. Open File Explorer (Win + E)"
        BitLockerUpgradeMethod3Step2 = "2. Right-click on Drive C:"
        BitLockerUpgradeMethod3Step3 = "3. Click on 'Disable BitLocker'"
        BitLockerUpgradeMethod3Step4 = "4. Continue as Method 1 (Steps 5-7)"
        BitLockerUpgradeAlt = "ALTERNATIVE (POWERSHELL):"
        BitLockerUpgradeAltCmd1 = "manage-bde -status C:        # Check status"
    ...
    de = @{
        ...
        MainMenuAuditFollow = "-> DNS, RDP, Netzwerk & OneDrive Konfiguration folgt"
        MainMenuEnforce = "Enforce-Modus"
        MainMenuEnforceDesc = "ALLES anwenden inkl. ASR blockieren"
        MainMenuEnforceFollow = "-> DNS, RDP, Netzwerk & OneDrive Konfiguration folgt"
        MainMenuCustom = "Angepasster Modus"
        MainMenuCustomDesc = "Module einzeln auswaehlen"
        MainMenuCustomFollow = "-> ASR, DNS, RDP, Netzwerk & OneDrive Konfiguration folgt"
        MainMenuVerify = "Verifizieren"
        MainMenuVerifyDesc = "Pruefen ob Baseline angewendet"
        MainMenuExit = "Beenden"
        MainMenuExitDesc = "Programm verlassen"
        ...
        EnforceBannerNetworkTitle = "NETWORK:"
        EnforceBannerNetwork1 = "DNS over HTTPS (Auswahl: Cloudflare/AdGuard/NextDNS/Quad9 oder DNS behalten)"
        EnforceBannerNetwork2 = "DNS Blocklist (107.000+ Malware/Tracking/Phishing-Domains)"
        EnforceBannerNetwork3 = "Firewall Default Deny + Block All Inbound"
        EnforceBannerNetwork4 = "SMB Signing + NetBIOS + LLMNR + mDNS disabled"
        EnforceBannerNetwork5 = "Remote Access konfigurierbar (Desktop Mode=AUS, Remote Mode=AN)"
        ...
        EnforceBannerBloatwareTitle = "BLOATWARE & PERFORMANCE:"
        EnforceBannerBloatware1 = "80+ Bloatware-Apps entfernt (Xbox, Teams, Copilot, Candy Crush, etc.)"
        ...
        ModuleSelectionA = "[A]                        - ALLE Module auswaehlen"
        ModuleSelectionN = "[N]                        - Nichts auswaehlen (Pflicht-Module bleiben aktiv)"
        ModuleSelectionEnter = "[ENTER]                    - Auswahl bestaetigen und starten"
        ModuleSelectionEsc = "[ESC]                      - Zurueck zum Hauptmenue (ohne Aenderungen)"
        ModuleSelectionHint = "HINWEIS:"
        ModuleSelectionMandatory = "GELBE Module sind Pflicht und immer aktiv!"
        ModuleSelectionMandatoryTag = "[PFLICHT - KANN NICHT DEAKTIVIERT WERDEN]"
        
        # ISE Warning
        ISEWarningTitle = "WARNUNG: PowerShell ISE NICHT UNTERSTUETZT!"
        ISEWarningMessage = "Custom Mode benoetigt Pfeiltasten-Navigation."
        ISEWarningNotWork = "Diese funktionieren NICHT in PowerShell ISE!"
        ISEWarningSolution = "LOESUNG:"
        ISEWarningStep1 = "1. Oeffnen Sie eine NORMALE PowerShell Console"
        ISEWarningStep2 = "2. Fuehren Sie das Script dort aus"
        ISEWarningAlternative = "Alternative: Verwenden Sie Audit/Enforce Mode (Option 1/2)"
        
        # Audit Mode
        AuditModeTitle = "Audit Mode"
        AuditModeBannerTitle = "AUDIT MODE - SICHERER TEST-MODUS:"
        AuditModeWhatHappens = "Was passiert:"
        AuditModeStep1 = "1. Die komplette Security Baseline wird angewendet (Core, Advanced, DNS, ...)"
        AuditModeStep2 = "2. ASR Rules laufen im AUDIT-Modus:"
        AuditModeStep2a = "- Ereignisse werden geloggt"
        AuditModeStep2b = "- Aber NICHT blockiert"
        AuditModeStep2c = "- Microsoft Best Practice: Erst Audit, dann Enforce!"
        AuditModeImportant = "WICHTIG:"
        AuditModeImportantMsg = "Audit Mode betrifft NUR ASR Rules."
        AuditModeUnchanged = "Alle anderen Security-Settings werden normal (ENFORCE) gesetzt."
        AuditModeContinue = "Moechten Sie fortfahren? [J/N]:"
        
        # Custom Mode Summary
        CustomModeSummaryTitle = "Custom Mode"
        CustomModeSelectedModules = "Ausgewaehlte Module:"
        CustomModeStep2 = "SCHRITT 2: Waehlen Sie den Modus fuer ASR-Regeln:"
        CustomModeReady = "BEREIT ZUM START!"
        CustomModeModuleCount = "Ausgewaehlte Module: {0}"
        CustomModeASRMode = "ASR-Modus: {0}"
        CustomModeWillStart = "Das Script wird jetzt mit Ihrer Konfiguration gestartet."
        CustomModeStartNow = "Moechten Sie JETZT starten? [J/N]:"
        CustomModeNoModules = "Keine Module ausgewaehlt!"
        
        # Verify Mode
        VerifyModeTitle = "Verify Mode"
        VerifyModeMessage = "Verify prueft ob die Baseline korrekt angewendet wurde."
        VerifyModeCall = "Dies ruft das Verify-Skript auf."
        VerifyModeContinue = "Moechten Sie fortfahren? [J/N]:"
        VerifyModeErrorPath = "[FEHLER] Script-Pfad konnte nicht ermittelt werden (dot-sourced script?)"
        VerifyModeErrorRunManual = "Bitte fuehren Sie das Verify-Skript direkt aus."
        VerifyModeStarting = "[INFO] Starte Verify-Skript..."
        VerifyModeComplete = "[OK] Verify-Skript abgeschlossen"
        VerifyModeErrorNotFound = "[FEHLER] Verify-Skript nicht gefunden!"
        VerifyModeErrorExpected = "Erwartet: {0}"
        VerifyModeErrorRun = "[FEHLER] Fehler beim Ausfuehren des Verify-Skripts!"
        VerifyModeErrorDetails = "Details: {0}"
        
        # Safety Check
        SafetyCheckQuestion = "Haben Sie die README gelesen UND ein System-Backup erstellt?"
        SafetyCheckYes = "Ja, ich habe alles gelesen und ein Backup erstellt"
        SafetyCheckNo = "Nein, ich breche ab"
        UserInputPrompt = "Ihre Eingabe"
        ...
        # Backup Creation Messages
        BackupFullCreating = "VOLLSTAENDIGES BACKUP WIRD ERSTELLT - 494 EINSTELLUNGEN"
        BackupIncludes = "[i] Das Backup umfasst:"
        BackupIncludesDNS = "    - DNS Settings + DoH (meist Router-DNS, kein DoH)"
        BackupIncludesHosts = "    - Hosts-Datei (Windows-Default ~5 Zeilen, ohne 107.772 Domains Blocklist)"
        BackupIncludesServices = "    - Services (25+ Services die Script aendert)"
        BackupIncludesFirewall = "    - Firewall (alle Regeln + 3 Profile Domain/Private/Public)"
        BackupIncludesTasks = "    - Scheduled Tasks (30 Tasks die Script aendert)"
        BackupIncludesRegistry = "    - Registry (478 Keys die Script aendert)"
        BackupIncludesUsers = "    - Built-in Admin (Name 'Administrator' + Enabled=$false)"
        BackupIncludesApps = "    - Installierte Apps (Liste mit Namen, NICHT die Apps selbst)"
        BackupIncludesASR = "    - ASR (19 Regeln) + Exploit Protection (13 Mitigations)"
        ...
        DNSBlocklistInstalling = "DNS Blocklist wird installiert (107K+ Domains)..."
        ...
        DNSAntivirusInfo = "Antivirus-Software scannt hosts-Datei nach Installation (normal, kurzzeitig)"
        DNSAntivirusScanTime = "Scan dauert Sekunden bis Minuten je nach AV - keine Aktion noetig"
        DNSAntivirusException = "Bei anhaltenden Problemen: hosts-Datei temporaer zur AV-Ausnahme hinzufuegen (langfristig nicht empfohlen)"
        DNSAntivirusSecurity = "Wichtig: hosts-Datei SOLLTE vom AV gescannt werden (Sicherheit!)"
        ...
        # Bloatware Module
        BloatwareTitle = "Bloatware Entfuernung (Konservativ)"
        ...
        SpecificAppsTitle = "Spezifische App-Removal"
        ...
        CoreCFAActivated = "Controlled Folder Access aktiviert (Ransomware-Schutz)"
        CoreCFAProtected = "Geschuetzte Ordner: Dokumente, Bilder, Videos, Desktop"
        CoreCFAWhitelist = "Kann jederzeit deaktiviert werden: Windows-Sicherheit -> Viren- & Bedrohungsschutz -> Ransomwareschutz"
        CoreCFAWhitelistApps = "Legitime Apps koennen dort zur Whitelist hinzugefuegt werden"
        ...
        AdvancedWDigestDisabling = "Deaktiviere WDigest um Klartext-Passwoerter im RAM zu verhindern..."
        AdvancedWDigestDisabled = "WDigest-Authentifizierung deaktiviert"
        AdvancedWDigestProtected = "Zugangsdaten sind jetzt vor Mimikatz-Angriffen geschuetzt"
        AdvancedWDigestNote = "HINWEIS: Dies blockiert Digest-Authentifizierung (selten genutzt, Legacy-Protokoll)"
        AdvancedEFSDisabling = "Deaktiviere EFS RPC um NTLM-Relay-Angriffe zu verhindern..."
        AdvancedEFSDisabled = "EFS RPC deaktiviert (Auth-Coercion-Schutz)"
        AdvancedEFSBitLockerOK = "BitLocker ist NICHT betroffen (anderes System)"
        AdvancedEFSNote = "HINWEIS: Legacy-EFS-Verschluesselung funktioniert nicht mehr (BitLocker empfohlen)"
        AdvancedWebClientDisabling = "Deaktiviere WebClient-Dienst um Auth-Coercion-Angriffe zu verhindern..."
        AdvancedWebClientStopped = "WebClient-Dienst gestoppt"
        AdvancedWebClientDisabled = "WebClient-Dienst deaktiviert"
        AdvancedWebClientNotFound = "WebClient-Dienst nicht gefunden (evtl. nicht installiert)"
        AdvancedWebClientError = "Konnte WebClient-Dienst nicht deaktivieren: {0}"
        AdvancedWebClientRedirector = "WebDAV-Netzwerk-Redirector deaktiviert"
        AdvancedWebClientCloudOK = "Moderne Cloud-Dienste (OneDrive, Dropbox, etc.) NICHT betroffen"
        AdvancedWebClientNote = "HINWEIS: \\server\davwwwroot\ UNC-Pfade funktionieren NICHT"
        
        # Telemetry Module - Services
        TelemetryServicesTitle = "Telemetrie-Services deaktivieren"
        TelemetryServicesDisabling = "Telemetrie-Services werden deaktiviert..."
        TelemetryServicesSkippedCritical = "UEBERSPRUNGEN: {0} (kritisch fuer Windows-Funktionen)"
        TelemetryServicesSkippedDependent = "UEBERSPRUNGEN: {0} (hat {1} abhaengige Services)"
        TelemetryServicesDependentService = "     Abhaengiger Service: {0}"
        TelemetryServicesCheckDependentFailed = "Konnte abhaengige Services nicht pruefen fuer {0}: {1}"
        TelemetryServicesDeactivated = "     Deaktiviert: {0}"
        TelemetryServicesError = "Fehler bei {0}"
        TelemetryServicesDisabledCount = "{0} Telemetrie-Services deaktiviert"
        TelemetryServicesSkippedCount = "{0} kritische Services uebersprungen (wuerden Windows brechen)"
        
        # Telemetry Module - Registry
        TelemetryRegistryTitle = "Telemetrie-Registry-Keys setzen"
        TelemetryRegistrySetting = "Registry-Keys fuer Privacy werden gesetzt..."
        TelemetryPrivacyGeneralToggles = "Privacy | General: Alle 5 Toggles deaktivieren..."
        ...
        # Telemetry Module - Scheduled Tasks
        TelemetryTasksTitle = "Telemetrie Scheduled Tasks entfernen"
        TelemetryTasksDisabling = "Telemetrie-Tasks werden deaktiviert..."
        TelemetryTasksDeactivated = "     Deaktiviert: {0}"
        TelemetryTasksAlreadyDisabled = "     Bereits deaktiviert (uebersprungen): {0}"
        TelemetryTasksError = "Fehler bei {0}: {1}"
        TelemetryTasksDisabledCount = "{0} Telemetrie-Tasks deaktiviert"
        TelemetryTasksNotFoundCount = "{0} Tasks nicht gefunden (evtl. schon entfernt)"
        
        # Telemetry Module - Firewall/Hosts Blocking
        TelemetryHostsTitle = "Telemetrie-Hosts blockieren (Firewall)"
        TelemetryHostsSkipped = "Firewall-Blockierung uebersprungen (technische Limitierung)"
        TelemetryHostsReason = "GRUND: Windows Firewall akzeptiert nur IP-Adressen, keine Hostnamen"
        TelemetryHostsAlternative = "ALTERNATIVE: Telemetrie wird via Registry + Services blockiert (bereits aktiv)"
        TelemetryHostsBlocking = "Telemetrie-Endpunkte werden blockiert..."
        TelemetryHostsBlocked = "Telemetrie-Hosts blockiert ({0} Endpunkte in {1} Regeln)"
        TelemetryHostsWindowsUpdateOK = "Windows Update funktioniert weiterhin normal!"
        TelemetryHostsNoRules = "Keine Telemetrie-Firewall-Regeln konnten erstellt werden"
        TelemetryHostsRuleError = "Fehler beim Erstellen der Firewall-Regel {0}: {1}"
        
        # Telemetry Module - Status Report
        TelemetryStatusTitle = "Telemetrie-Status Report"
        TelemetryStatusCreating = "Erstelle Telemetrie-Status-Report..."
        TelemetryStatusDeactivated = "\n=== DEAKTIVIERT ([OK]) ==="
        TelemetryStatusDiagTrack = "[OK] DiagTrack Service (Connected User Experiences)"
        TelemetryStatusWAPPush = "[OK] dmwappushservice (WAP Push Routing)"
        TelemetryStatusErrorReporting = "[OK] WerSvc (Windows Error Reporting)"
        TelemetryStatusRegistry = "[OK] Telemetrie-Registry (AllowTelemetry = 0)"
        TelemetryStatusAppTelemetry = "[OK] Application Telemetry"
        TelemetryStatusAdvertisingID = "[OK] Advertising ID"
        TelemetryStatusActivityHistory = "[OK] Activity History / Timeline"
        TelemetryStatusCloudClipboard = "[OK] Cloud Clipboard"
        ...
        TelemetryStatusTailoredExp = "[OK] Tailored Experiences"
        TelemetryStatusConsumerFeatures = "[OK] Consumer Features (Auto-Install Apps)"
        TelemetryStatusScheduledTasks = "[OK] ~14 Telemetrie Scheduled Tasks"
        TelemetryStatusFirewallHosts = "[OK] ~45 Telemetrie-Hosts (Firewall)"
        TelemetryStatusNotDeactivated = "\n=== NICHT DEAKTIVIERT ([!]) - WARUM? ==="
        TelemetryStatusWindowsUpdate = "[!] Windows Update Service"
        TelemetryStatusUpdateReason = "      GRUND: Kritisch fuer Sicherheits-Updates!"
        TelemetryStatusUpdateWithout = "      Ohne das: KEINE Windows/Defender-Updates!"
        TelemetryStatusDiagPolicy = "[!] Diagnostic Policy Service (DPS)"
        TelemetryStatusDiagPolicyReason = "      GRUND: Windows Troubleshooter braucht das!"
        TelemetryStatusDiagPolicyWithout = "      Ohne das: Problembehandlung funktioniert nicht!"
        TelemetryStatusDiagSystemHost = "[!] Diagnostic System Host (WdiSystemHost)"
        TelemetryStatusDiagSystemReason = "      GRUND: System-Diagnosen (z.B. Festplatten-Check)"
        TelemetryStatusDiagSystemWithout = "      Ohne das: Keine Hardware-Diagnosen moeglich!"
        TelemetryStatusMinimalTelemetry = "[!] Minimal-Telemetrie (Security Level = 0)"
        TelemetryStatusMinimalReason = "      GRUND: Windows Update + Defender brauchen Basis-Telemetrie!"
        TelemetryStatusMinimalWhat = "      WAS WIRD GESENDET: Nur kritische Security-Events"
        TelemetryStatusMinimalNot = "      NICHT gesendet: Nutzungs-Daten, App-Listen, Browsing, etc."
        TelemetryStatusResult = "\n=== ERGEBNIS ==="
        TelemetryStatus95Percent = "[OK] ~95% Telemetrie deaktiviert"
        TelemetryStatusOnlySecurity = "[OK] Nur Security-kritische Basis-Telemetrie aktiv"
        TelemetryStatusNoTracking = "[OK] KEINE Nutzungs-Daten, Advertising, Tracking"
        TelemetryStatusUpdateWorks = "[OK] Windows Update + Defender funktionieren!"
        TelemetryStatusMaxPrivacy = "[OK] Maximum Privacy OHNE Funktionsverlust!"
        
        # Telemetry Module - Windows Search Web Features
        TelemetrySearchTitle = "Windows Search - Web-Features deaktivieren"
        TelemetrySearchSettingUser = "Setze User-Level Web Search Settings (HKCU)..."
        TelemetrySearchComplete = "Windows Search: Nur lokal, KEIN Web/Bing/Cloud!"
        TelemetrySearchNoWebResults = "Start Menu Search zeigt jetzt KEINE Web-Ergebnisse mehr"
        
        # Telemetry Module - Camera and Microphone
        TelemetryCameraTitle = "Kamera und Mikrofon - APP-BERECHTIGUNGEN entfernen"
        TelemetryCameraRemoving = "Entferne Kamera und Mikrofon Berechtigungen fuer ALLE Apps..."
        TelemetryCameraHKCUValue = "     Kamera HKCU: Value=Deny"
        TelemetryCameraAppError = "     Kamera App '{0}' Fehler: {1}"
        TelemetryCameraAppsEnumError = "Kamera Apps Enumeration Fehler (nicht kritisch): {0}"
        TelemetryCameraHKCUError = "Kamera HKCU Fehler: {0}"
        TelemetryCameraHKLMValue = "     Kamera HKLM: Value=Deny"
        TelemetryCameraHKLMError = "Kamera HKLM Fehler: {0}"
        TelemetryMicrophoneHKCUValue = "     Mikrofon HKCU: Value=Deny"
        TelemetryMicrophoneAppError = "     Mikrofon App '{0}' Fehler: {1}"
        TelemetryMicrophoneAppsEnumError = "Mikrofon Apps Enumeration Fehler (nicht kritisch): {0}"
        TelemetryMicrophoneHKCUError = "Mikrofon HKCU Fehler: {0}"
        TelemetryMicrophoneHKLMValue = "     Mikrofon HKLM: Value=Deny"
        TelemetryMicrophoneHKLMError = "Mikrofon HKLM Fehler: {0}"
        TelemetryDeviceTogglesSet = "Setze Device-Level Toggles (Zugriff auf Kamera/Mikrofon)..."
        TelemetryCameraDeviceToggle = "     Device-Toggle Kamera: {0} = AUS"
        TelemetryCameraDeviceError = "Kamera Device-Level Toggle Fehler: {0}"
        TelemetryMicrophoneDeviceToggle = "     Device-Toggle Mikrofon: {0} = AUS"
        TelemetryMicrophoneDeviceError = "Mikrofon Device-Level Toggle Fehler: {0}"
        TelemetryDeviceTogglesComplete = "Device-Level Toggles gesetzt - 'Zugriff auf Kamera/Mikrofon' sollte jetzt AUS sein"
        TelemetryCameraAllDisabled = "Kamera: ALLE Standard-Apps deaktiviert (User muss pro App zustimmen)"
        TelemetryCameraConsentStore = "Kamera ConsentStore: '{0}' (erwartet: Deny)"
        TelemetryMicrophoneAllDisabled = "Mikrofon: ALLE Standard-Apps deaktiviert (User muss pro App zustimmen)"
        TelemetryMicrophoneConsentStore = "Mikrofon ConsentStore: '{0}' (erwartet: Deny)"
        TelemetryStopSettingsApp = "Stoppe Settings App damit Aenderungen sofort sichtbar werden..."
        TelemetrySettingsAppRestarted = "     Settings App wurde neu gestartet"
        TelemetrySettingsAppNotOpen = "Settings App war nicht geoeffnet - OK"
        TelemetryFlushRegistryCache = "Flushe Registry-Cache..."
        TelemetryRegistryCacheFlushed = "     Registry-Cache geflushed"
        TelemetryRegistryCacheOptional = "Registry-Cache Flush optional"
        TelemetryImportantChangeSeparator = "========================================"
        TelemetryImportantWin11Change = "WICHTIG: WINDOWS 11 24H2/25H2 AENDERUNG!"
        TelemetrySQLiteChange = "Ab Windows 11 24H2/25H2 verwendet Windows eine SQLite-Datenbank fuer Privacy-Einstellungen!"
        TelemetryStandardAppsDisabled = "Das Script hat alle STANDARD-APPS deaktiviert - funktioniert:"
        TelemetryAppsNeedPermission = "  - Apps brauchen DEINE ERLAUBNIS fuer Kamera/Mikrofon-Zugriff"
        TelemetryWindowsAsksFirst = "  - Beim ersten Zugriff fragt Windows: 'Darf [App] zugreifen?'"
        TelemetryUserCanAllow = "  - Du kannst dann Allow oder Deny klicken"
        TelemetryMasterTogglesManual = "ABER: Die MASTER-TOGGLES in Settings koennen NUR MANUELL geaendert werden!"
        TelemetryRecommendedManual = "EMPFOHLEN: Schalte die Master-Toggles manuell AUS:"
        TelemetryOpenSettings = "  1. Oeffne: Settings (Windows-Taste + I)"
        TelemetryCameraSettings = "  2. Gehe zu: Privacy and security | Camera"
        TelemetryCameraAccessOff = "  3. Schalte AUS: 'Camera access' (oberster Toggle)"
        TelemetryCameraAppsOff = "  4. Schalte AUS: 'Let apps access your camera' (zweiter Toggle)"
        TelemetryMicrophoneSettings = "  5. Gehe zu: Privacy and security | Microphone"
        TelemetryMicrophoneAccessOff = "  6. Schalte AUS: 'Microphone access' (oberster Toggle)"
        TelemetryMicrophoneAppsOff = "  7. Schalte AUS: 'Let apps access your microphone' (zweiter Toggle)"
        TelemetryResultMaxPrivacy = "ERGEBNIS: Maximale Privacy + Du behaeltst volle Kontrolle!"
        TelemetryCanAllowIndividual = "Du kannst jederzeit einzelne Apps in Settings erlauben."
        TelemetryHardwareInfo = "HARDWARE-INFO: Die physischen Kamera/Mikrofon-Geraete bleiben aktiv"
        TelemetryHardwareDisable = "Um Hardware zu deaktivieren: Geraete-Manager | Kamera/Audio | Rechtsklick | Deaktivieren"
        
        # Telemetry Module - Privacy Experience Settings
        TelemetryPrivacyExpTitle = "Privacy Experience Settings deaktivieren"
        TelemetryPrivacyExpComplete = "Privacy Experience: Vorgeschlagene Inhalte deaktiviert"
        
        # Telemetry Module - Inking and Typing Personalization
        TelemetryInkingTitle = "Freihand- und Eingabeanpassung deaktivieren"
        TelemetryInkingSettingUser = "Setze User-Level Inking and Typing Settings (HKCU)..."
        TelemetryInkingComplete = "Freihand- und Eingabeanpassung: KEINE Datensammlung"
        TelemetryInkingSettingsOff = "Settings | Privacy and security | Inking and typing personalization ist jetzt OFF"
        
        # Telemetry Module - Location Services
        TelemetryLocationTitle = "Standortdienste deaktivieren"
        TelemetryLocationSettingHKCU = "Setze Location auch fuer aktuellen User (HKCU)..."
        TelemetryLocationHKCUValue = "     Location HKCU: Value=Deny"
        TelemetryLocationAppError = "     Location App '{0}' Fehler: {1}"
        TelemetryLocationAppsEnumError = "Location Apps Enumeration Fehler (nicht kritisch): {0}"
        TelemetryLocationHKCUError = "Location HKCU Fehler: {0}"
        TelemetryLocationComplete = "Location: Standard-Apps deaktiviert (User muss pro App zustimmen)"
        TelemetryLocationMasterToggle = "Master-Toggle muss in Settings (Privacy | Location) manuell ausgeschaltet werden (25H2)"
        
        # Telemetry Module - App Permissions (All 34 Permissions)
        TelemetryAppPermTitle = "App Permissions - Privacy by Default (Complete)"
        TelemetryAppPermSetting = "Setze ALLE App Permissions auf OFF (User kann individuell aktivieren)..."
        TelemetryAppPermVerboseSpeech = "Speech Recognition OFF..."
        TelemetryAppPermVerboseNotif = "Notifications Access OFF..."
        TelemetryAppPermVerboseAccount = "Account Info Access OFF..."
        TelemetryAppPermVerboseContacts = "Contacts Access OFF..."
        ...
        TelemetryAppPermVerboseWiFiData = "WiFi Data Access OFF..."
        TelemetryAppPermVerboseWiFiDirect = "WiFi Direct Access OFF..."
        TelemetryAppPermSettingHKCU = "Setze Permissions auch fuer AKTUELLEN User (HKCU)..."
        TelemetryAppPermHKCUDeny = "     HKCU: {0} = Deny"
        TelemetryAppPermAppError = "     App '{0}' Fehler: {1}"
        TelemetryAppPermAppsEnumError = "Permission '{0}' Apps Enumeration Fehler (nicht kritisch): {1}"
        TelemetryAppPermHKCUError = "HKCU Permission '{0}' Fehler: {1}"
        TelemetryAppPermStoppingSettings = "Stoppe Settings App damit Aenderungen sofort sichtbar werden..."
        TelemetryAppPermSettingsStopped = "     Settings App erfolgreich gestoppt"
        TelemetryAppPermSettingsNotStopped = "Settings App konnte nicht beendet werden"
        TelemetryAppPermSettingsStopFailed = "Settings App stoppen fehlgeschlagen: {0}"
        TelemetryAppPermComplete = "App Permissions: ALLE 33 Kategorien - Standard-Apps deaktiviert!"
        TelemetryAppPermNeedConsent = "Apps brauchen DEINE ERLAUBNIS fuer Zugriff auf Daten!"
        TelemetryAppPermSQLiteInfo = "Ab Windows 11 24H2/25H2 verwendet Windows eine SQLite-Datenbank fuer Privacy-Einstellungen!"
        TelemetryAppPermStandardDisabled = "Das Script hat alle STANDARD-APPS deaktiviert fuer:"
        TelemetryAppPermCategories = "  - Notifications, Contacts, Calendar, Email, Messages"
        TelemetryAppPermMoreCategories = "  - Account Info, Phone Calls, Documents, Pictures, Videos"
        TelemetryAppPermEvenMore = "  - Location, Bluetooth, WiFi, USB, und 20+ weitere"
        TelemetryAppPermDefaultPrivacy = "Privacy by Default: Apps brauchen DEINE ERLAUBNIS!"
        TelemetryAppPermFirstAccess = "  - Beim ersten Zugriff fragt Windows: 'Darf [App] zugreifen?'"
        TelemetryAppPermCanDeny = "  - Du kannst dann Allow oder Deny klicken"
        TelemetryAppPermTogglesManual = "ABER: Die MASTER-TOGGLES in Settings koennen NUR MANUELL geaendert werden!"
        TelemetryAppPermOptionalManual = "OPTIONAL: Du kannst die Master-Toggles manuell ausschalten:"
        TelemetryAppPermOpenSettings = "  1. Oeffne: Settings (Windows-Taste + I) | Privacy and security"
        TelemetryAppPermGoThrough = "  2. Gehe durch alle Kategorien (Notifications, Contacts, etc.)"
        TelemetryAppPermTurnOffTop = "  3. Schalte jeweils den obersten Toggle AUS"
        TelemetryAppPermTipOptional = "TIPP: Das ist OPTIONAL! Auch ohne Toggle-Aenderung:"
        TelemetryAppPermNoAccessUntil = "  - Apps haben keinen Zugriff bis du erlaubst"
        TelemetryAppPermGuaranteed = "  - Privacy ist garantiert!"
        TelemetryAppPermResultControl = "ERGEBNIS: Privacy + Du behaeltst volle Kontrolle!"
        
        # Telemetry Module - Game Bar and Game Mode
        TelemetryGameBarTitle = "Xbox Game Bar und Game Mode deaktivieren"
        TelemetryGameBarComplete = "Xbox Game Bar und Game Mode deaktiviert"
        TelemetryGameBarWindowsKeyG = "Windows-Taste + G oeffnet jetzt NICHTS mehr"
        TelemetryGameBarAutoMode = "Game Mode wird NICHT automatisch aktiviert"
        ...
        EdgeSyncPrivacyConfig = "Konfiguriere Edge Sync & Privacy (Microsoft Account Datensammlung blockieren)..."
        EdgeSyncDisabled = "Edge Sync DEAKTIVIERT - Keine Datenuploads zum Microsoft-Konto!"
        EdgeSearchSuggestDisabled = "Suchvorschlaege DEAKTIVIERT - Keine Anfragen zu Bing!"
        EdgeNoDataToMS = "Edge sendet KEINE Browsing-Daten mehr an Microsoft!"
        EdgeMSAccountWarningTitle = "  [!] WICHTIG: Microsoft-Account-User"
        EdgeMSAccountWarningText = "  Wenn du in Edge mit einem Microsoft-Konto angemeldet bist:"
        EdgeMSAccountStep1 = "    1. Oeffne Edge -> Einstellungen -> Profile"
        EdgeMSAccountStep2 = "    2. Klicke auf 'Sync DEAKTIVIEREN' (trotz Policy)"
        EdgeMSAccountStep3 = "    3. Loesche bereits synchronisierte Daten im Microsoft-Konto:"
        EdgeMSAccountURL = "       https://account.microsoft.com/privacy/activity-history"
        EdgeMSAccountStep4 = "    4. Edge NEU STARTEN fuer volle Wirkung!"
        ...
        BackupServicesNote = "[i] Dadurch koennen wir 100% wiederherstellen"
        BackupFirewall = "Firewall-Regeln werden gesichert..."
        BackupFirewallSaved = "Firewall-Regeln gesichert (ALLE!)"
        BackupFirewallNote = "[i] Inkl. Status aller Standard-Regeln"
        ...
        BackupNote = "[!] Wiederherstellung: Skript erneut starten und 'Restore' im Menue waehlen."
        ...
        BackupAppsReading = "Lese installierte Apps (max 60s)..."
        ...
        BackupProvisionedReading = "Lese Provisioned Packages (max 90s)..."
        ...
        BackupScheduledTasksNote = "[i] Nur State (Enabled/Disabled/Ready) wird gebackupt"
        BackupASRTitle = "Backup ASR Rules..."
        ...
        AppListFileIntro = "Diese Apps wurden durch das Security Baseline Script entfernt`r`nund muessen manuell ueber den Microsoft Store neu installiert werden:"
        ...
        AppListFileNote = "HINWEIS: Einige Apps sind moeglicherweise in Ihrer Region nicht verfuegbar`r`n         oder wurden von Microsoft eingestellt."
        ...
        RestoreRebootCountdown = "{0} Sekunden..."
        
        # Restore - Zusaetzliche fehlende Strings
        RestoreNoTasksInBackup = "Keine Scheduled Tasks im Backup"
        RestorePasswordCopied = "Passwort wurde in Zwischenablage kopiert!"
        RestorePasswordPasteNow = "Bitte JETZT in Passwort-Manager einfuegen!"
        RestorePasswordClearIn30 = "Zwischenablage wird in 30 Sekunden geloescht!"
        RestorePasswordClipboardFailed = "Zwischenablage nicht verfuegbar - Passwort wird unten angezeigt:"
        RestorePasswordWait30 = "Warte 30 Sekunden bevor Zwischenablage geleert wird..."
        RestorePasswordSecondsLeft = "{0} Sekunden verbleiben..."
        RestorePasswordCleared = "Zwischenablage geleert (Sicherheit)"
        RestoreASRSuccess = "{0} ASR Rules wiederhergestellt"
        RestoreASRNotAvailable = "Set-MpPreference nicht verfuegbar"
        RestoreASRFailed = "ASR Rules Restore fehlgeschlagen:"
        RestoreASRNoBackup = "Keine ASR Rules im Backup"
        RestoreExploitNotAvailable = "Set-ProcessMitigation nicht verfuegbar (Windows 10 1709+ erforderlich)"
        RestoreExploitSuccess = "Exploit Protection: {0} Mitigations aus Backup wiederhergestellt"
        RestoreExploitAllFailed = "Exploit Protection: Alle Mitigations fehlgeschlagen (inkompatibles System?)"
        RestoreExploitNoMitigations = "Exploit Protection: Keine Mitigations im Backup (urspruenglich nicht aktiviert)"
        RestoreExploitFailed = "Exploit Protection Restore fehlgeschlagen:"
        RestoreExploitNoBackup = "Keine Exploit Protection im Backup (oder nicht aktiviert)"
        RestoreDohSuccess = "DoH Konfiguration aus Backup wiederhergestellt ({0} Server)"
        RestoreDohNoServers = "Keine DoH Server wiederhergestellt"
        RestoreDohFailed = "DoH Restore fehlgeschlagen:"
        RestoreDohNoBackup = "Keine DoH Konfiguration im Backup"
        RestoreDohRemoved = "DoH Konfiguration entfernt (Backup hatte keine)"
        RestoreDohEncryptionSuccess = "DoH Encryption: {0} Adapter, {1} DNS-Server wiederhergestellt"
        RestoreDohEncryptionNoServers = "Keine DoH Encryption Preferences wiederhergestellt"
        RestoreDohEncryptionFailed = "DoH Encryption Preferences Restore fehlgeschlagen:"
        RestoreDohEncryptionNoBackup = "Keine DoH Encryption Preferences im Backup"
        RestoreFirewallProfileSuccess = "Firewall Profile '{0}' wiederhergestellt"
        RestoreFirewallProfileFailed = "Firewall Profile '{0}' konnte nicht wiederhergestellt werden:"
        RestoreFirewallProfilesSuccess = "{0} Firewall Profile wiederhergestellt"
        RestoreFirewallProfilesError = "Firewall Profile Restore fehlgeschlagen:"
        RestoreFirewallProfilesNoBackup = "Keine Firewall Profiles im Backup"
        RestoreDeviceAppFailed = "Device-Level App '{0}' konnte nicht wiederhergestellt werden:"
        RestoreDeviceAppSuccess = "{0} Device-Level Apps wiederhergestellt, {1} geloescht"
        RestoreDeviceAppNoChanges = "Keine Device-Level Apps benoetigten Wiederherstellung"
        RestoreDeviceAppError = "Device-Level App Restore fehlgeschlagen:"
        
        # OneDrive Menu
        OneDriveMenuTitle = "ONEDRIVE KONFIGURATION"
        OneDriveMenuQuestion = "Wie soll OneDrive konfiguriert werden?"
        OneDriveMenuOption1 = "Privacy Haertung (Empfohlen)"
        OneDriveMenuOption1Desc1 = "Blockiert Telemetrie und automatische Uploads"
        OneDriveMenuOption1Desc2 = "OneDrive bleibt funktional fuer manuelle Nutzung"
        OneDriveMenuOption1Desc3 = "Sie behalten volle Kontrolle ueber Synchronisation"
        OneDriveMenuOption2 = "Vollstaendige Deinstallation (Erweitert)"
        OneDriveMenuOption2Desc1 = "Deinstalliert OneDrive vollstaendig"
        OneDriveMenuOption2Warning = "WARNUNG: Kann NICHT aus Backup wiederhergestellt werden!"
        OneDriveMenuOption2Desc2 = "Ihr OneDrive-Ordner und Dateien bleiben sicher"
        OneDriveMenuOption2Desc3 = "Kann bei Bedarf manuell neu installiert werden"
        OneDriveMenuOption3 = "Ueberspringen (Keine Aenderungen)"
        OneDriveMenuOption3Desc = "OneDrive bleibt unveraendert"
        OneDriveMenuPrompt = "Ihre Auswahl (1-3)"
        
        # Remote Access Menu
        RemoteMenuTitle = "REMOTE ACCESS & FIREWALL KONFIGURATION"
        RemoteMenuQuestion = "Nutzen Sie Remote Desktop (RDP) oder lokale Dienste?"
        RemoteMenuExamples = "Beispiele:"
        RemoteMenuExample1 = "Remote-Zugriff via RDP, TeamViewer oder Tailscale"
        RemoteMenuExample2 = "Docker Container mit Inter-Container-Kommunikation"
        RemoteMenuExample3 = "Lokale AI/LLM-Dienste (OpenWebUI, Ollama, etc.)"
        RemoteMenuExample4 = "Entwicklungsserver (Node, Python, WSL)"
        RemoteMenuExample5 = "Online Multiplayer-Spiele, die eingehende Verbindungen benoetigen (Hosting, bestimmte P2P-Titel)"
        RemoteMenuOption1 = "Maximale Sicherheit (Standard-Empfehlung)"
        RemoteMenuOption1Desc1 = "RDP vollstaendig DEAKTIVIERT"
        RemoteMenuOption1Desc2 = "Firewall blockiert ALLE eingehenden Verbindungen (inkl. 'erlaubte Apps')"
        RemoteMenuOption1Desc3 = "Ruhezustand AKTIVIERT (30 Min) - RAM auf BitLocker-verschluesselte Festplatte (Cold Boot Attack-Schutz)"
        RemoteMenuOption1Desc4 = "Geeignet fuer: Desktop/Laptop, Buero, Surfen, die meisten Spiele"
        RemoteMenuOption1Pro = "Pro: Starke Reduzierung der Angriffsflaeche + RAM-Sicherheit (Ruhezustand loescht sensible Daten)"
        RemoteMenuOption1Con = "Contra: Kein Remote-Zugriff, lokale Serverdienste funktionieren evtl. nicht"
        RemoteMenuOption1Warning1 = "Hinweis: Multiplayer-Spiele mit eingehenden Verbindungen funktionieren evtl. NICHT."
        RemoteMenuOption1Warning2 = "(z.B. wenn Sie selbst Spiele hosten oder P2P-Verbindungen nutzen)"
        RemoteMenuOption2 = "Remote-Zugriff + Lokale Dienste erlauben (weniger strikt)"
        RemoteMenuOption2Desc1 = "RDP bleibt AKTIVIERT (z.B. fuer Tailscale/VPN/Remote-Administration)"
        RemoteMenuOption2Desc2 = "Firewall erlaubt Localhost- und regelbasierte eingehende Verbindungen"
        RemoteMenuOption2Desc3 = "Ruhezustand AUS - System bleibt 24/7 AN (keine RDP-Trennungen, Dienste laufen)"
        RemoteMenuOption2Desc4 = "Nur nutzen wenn Remote-Zugriff/lokale Server/Multiplayer benoetigt werden"
        RemoteMenuOption2Pro1 = "Pro: Remote-Zugriff + Docker/LLM/WSL bleiben voll nutzbar"
        ...
        RemoteMenuRecommendation = "[Empfehlung: Bei Unsicherheit Option 1 waehlen.`n               Option 2 nur bei Remote-Zugriff/Diensten oder wenn Spiele fehlschlagen.]"
        RemoteMenuPrompt = "Ihre Auswahl (1-2)"
        
        # Network Discovery Menu
        NetworkMenuTitle = "NETZWERK-ERKENNUNG & GERAETE-KOMMUNIKATION"
        NetworkMenuQuestion = "Wie nutzen Sie Ihr Netzwerk und Smart Devices?"
        NetworkMenuOption1 = "Maximale Sicherheit (Stealth-Modus)"
        NetworkMenuOption1Baseline = "Microsoft Baseline: NetBIOS deaktiviert"
        NetworkMenuOption1Extra1 = "+ EXTRA Sicherheit: LLMNR deaktiviert"
        NetworkMenuOption1Extra2 = "+ EXTRA Sicherheit: mDNS deaktiviert"
        NetworkMenuOption1Extra3 = "+ EXTRA Sicherheit: Netzwerkerkennung deaktiviert"
        NetworkMenuOption1Extra4 = "+ EXTRA Sicherheit: WSD/SSDP deaktiviert"
        NetworkMenuOption1Pro1 = "Pro: Maximale Netzwerksicherheit (unsichtbar im Netzwerk)"
        NetworkMenuOption1Pro2 = "Pro: Kein Name Resolution Spoofing moeglich"
        NetworkMenuOption1Pro3 = "Pro: Keine automatische Geraete-Erkennung (Angriffsflaeche minimiert)"
        NetworkMenuOption1Con1 = "Contra: Keine Chromecast/Smart TV-Erkennung"
        NetworkMenuOption1Con2 = "Contra: Kein Miracast/Wireless Display"
        NetworkMenuOption1Con3 = "Contra: Kein AirPlay"
        NetworkMenuOption1Con4 = "Contra: Keine automatische Drucker-Erkennung"
        NetworkMenuOption1Con5 = "Contra: Kein Explorer-Netzwerk-Browsing (\\PC-NAME funktioniert nicht)"
        NetworkMenuOption1Con6 = "Contra: Manuelle IP-Adressen erforderlich (\\192.168.1.100\share)"
        NetworkMenuOption1Recommended = "Empfohlen fuer: Unternehmen, Oeffentliches WLAN, Maximale Privatsphaere"
        NetworkMenuOption2 = "Home User (Nur moderne Protokolle)"
        NetworkMenuOption2Baseline = "Microsoft Baseline: NetBIOS deaktiviert"
        NetworkMenuOption2BestPractice = "Best Practice: LLMNR deaktiviert"
        NetworkMenuOption2Modern = "Moderner Standard: mDNS AKTIVIERT"
        NetworkMenuOption2Convenience1 = "Home Komfort: Netzwerkerkennung AKTIVIERT"
        NetworkMenuOption2Convenience2 = "Drucker-Erkennung: WSD/SSDP AKTIVIERT"
        NetworkMenuOption2Pro1 = "Pro: Legacy-Exploits blockiert (NetBIOS, LLMNR)"
        NetworkMenuOption2Pro2 = "Pro: Chromecast/Smart TV funktioniert"
        NetworkMenuOption2Pro3 = "Pro: Miracast/Wireless Display funktioniert"
        NetworkMenuOption2Pro4 = "Pro: AirPlay funktioniert"
        NetworkMenuOption2Pro5 = "Pro: Automatische Drucker-Erkennung funktioniert"
        NetworkMenuOption2Pro6 = "Pro: Netzwerk-Browsing funktioniert (mit DNS/IP-Fallback)"
        NetworkMenuOption2Note1 = "Hinweis: Immer noch sehr sicher (nur moderne Protokolle erlaubt)"
        NetworkMenuOption2Note2 = "Hinweis: mDNS ist schwerer zu spoofing als NetBIOS/LLMNR"
        NetworkMenuOption2Recommended = "Empfohlen fuer: Heimnetzwerke, Smart Home-Nutzer, Gamer"
        NetworkMenuInfo1 = "Microsoft Security Baseline 25H2 erfordert nur NetBIOS-Deaktivierung."
        NetworkMenuInfo2 = "Option 2 uebertrifft MS Baseline bei Erhalt des Home-Komforts."
        NetworkMenuPrompt = "Ihre Auswahl (1-2)"
        
        # VBS/Credential Guard POST-REBOOT Verification
        VBSPostRebootTitle = "[!] VERIFIZIERUNG NACH NEUSTART ERFORDERLICH:"
        VBSPostRebootDesc = "Nach dem Neustart ueberpruefen Sie, ob VBS/Credential Guard TATSAECHLICH laufen:"
        VBSPostRebootCommand = "PowerShell-Befehl:"
        VBSPostRebootExpected = "Erwartete Ausgabe: 1 oder 2 (Credential Guard laeuft)"
        VBSPostRebootFailed = "Wenn Ausgabe leer oder 0: VBS/Credential Guard FEHLGESCHLAGEN!"
        VBSPostRebootCauses = "Haeufige Fehlerursachen:"
        VBSPostRebootCause1 = "- TPM 2.0 nicht vorhanden oder nicht aktiviert"
        VBSPostRebootCause2 = "- Virtualisierung im BIOS/UEFI deaktiviert"
        VBSPostRebootCause3 = "- Inkompatible CPU (Intel <8th Gen, AMD <Ryzen 2000)"
        VBSPostRebootCause4 = "- Inkompatibler Hypervisor (VMware, VirtualBox ohne Nested-VT)"
        
        # BitLocker NOT ACTIVE Warning
        BitLockerNotActiveTitle = "!!! KRITISCH: BITLOCKER IST NICHT AKTIV !!!"
        BitLockerNotActiveLine1 = "Policies sind konfiguriert, aber BitLocker ist NICHT aktiviert!"
        BitLockerNotActiveLine2 = "Ihr Laufwerk ist NICHT verschluesselt - Daten koennen gestohlen werden!"
        BitLockerNotActiveMustEnable = "SIE MUESSEN BITLOCKER MANUELL AKTIVIEREN:"
        BitLockerNotActiveOption1 = "Option 1: Systemsteuerung"
        BitLockerNotActiveOption1Step1 = "1. Systemsteuerung oeffnen"
        BitLockerNotActiveOption1Step2 = "2. Navigieren zu: System und Sicherheit -> BitLocker-Laufwerkverschluesselung"
        BitLockerNotActiveOption1Step3 = "3. Klicken Sie auf 'BitLocker aktivieren' fuer Laufwerk C:"
        BitLockerNotActiveOption1Step4 = "4. Wiederherstellungsschluessel in Microsoft-Konto speichern (empfohlen)"
        BitLockerNotActiveOption2 = "Option 2: PowerShell (erfordert Admin-Rechte)"
        BitLockerNotActiveOption2Cmd = 'Enable-BitLocker -MountPoint "C:" -EncryptionMethod XtsAes256'
        BitLockerNotActiveFooter = "!!! OHNE BITLOCKER SIND IHRE DATEN NICHT VERSCHLUESSELT !!!"
        
        # BitLocker AES-256 Upgrade Instructions
        BitLockerUpgradeTitle = "SO UPGRADEN SIE AUF AES-256 (IN WINDOWS):"
        BitLockerUpgradeMethod1 = "METHODE 1 - Windows-Startmenue (EINFACHSTE):"
        BitLockerUpgradeMethod1Step1 = "1. Windows-Taste druecken"
        BitLockerUpgradeMethod1Step2 = "2. Eingeben: BitLocker verwalten"
        BitLockerUpgradeMethod1Step3 = "3. Enter druecken"
        BitLockerUpgradeMethod1Step4 = "4. Auf 'BitLocker deaktivieren' klicken"
        BitLockerUpgradeMethod1Step4Warn = "(WARNUNG: Dauert 30-90 Minuten!)"
        BitLockerUpgradeMethod1Step5 = "5. Warten bis 'BitLocker deaktiviert' angezeigt wird"
        BitLockerUpgradeMethod1Step6 = "6. Auf 'BitLocker aktivieren' klicken"
        BitLockerUpgradeMethod1Step6Info = "(Unsere Policy gilt = AES-256!)"
        BitLockerUpgradeMethod1Step7 = "7. <WICHTIG> Wiederherstellungsschluessel SPEICHERN (MS-Konto empfohlen)"
        BitLockerUpgradeMethod2 = "METHODE 2 - Systemsteuerung:"
        BitLockerUpgradeMethod2Step1 = "1. Systemsteuerung oeffnen"
        BitLockerUpgradeMethod2Step2 = "2. System und Sicherheit"
        BitLockerUpgradeMethod2Step3 = "3. BitLocker-Laufwerkverschluesselung"
        BitLockerUpgradeMethod2Step4 = "4. Weiter wie Methode 1 (Schritte 4-7)"
        BitLockerUpgradeMethod3 = "METHODE 3 - Datei-Explorer:"
        BitLockerUpgradeMethod3Step1 = "1. Datei-Explorer oeffnen (Win + E)"
        BitLockerUpgradeMethod3Step2 = "2. Rechtsklick auf Laufwerk C:"
        BitLockerUpgradeMethod3Step3 = "3. Auf 'BitLocker deaktivieren' klicken"
        BitLockerUpgradeMethod3Step4 = "4. Weiter wie Methode 1 (Schritte 5-7)"
        BitLockerUpgradeAlt = "ALTERNATIVE (POWERSHELL):"

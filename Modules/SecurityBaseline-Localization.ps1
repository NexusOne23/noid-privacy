...
$Global:Strings = @{
    en = @{
        ...
        DNSAntivirusCompatibility = "ANTIVIRUS COMPATIBILITY: hosts file with 107K+ entries"
    ...
    de = @{
        ...
        DNSAntivirusCompatibility = "ANTIVIRUS-KOMPATIBILITAET: hosts-Datei mit 107K+ Eintraegen"

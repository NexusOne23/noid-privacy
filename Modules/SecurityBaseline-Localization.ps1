...
$Global:Strings = @{
    en = @{
        ...
        RemoteMenuExample5 = "Online multiplayer games (Diablo, Call of Duty, etc.)"
        RemoteMenuOption1 = "Maximum Security (Recommended for Desktop/Laptop)"
        RemoteMenuOption1Desc1 = "RDP completely DISABLED"
        RemoteMenuOption1Desc2 = "Firewall blocks ALL inbound (ultra-strict)"
        RemoteMenuOption1Desc3 = "Best for: Standard workstations, office work, browsing"
        RemoteMenuOption1Pro = "Pro: Maximum attack surface reduction"
        RemoteMenuOption1Con = "Con: No remote access, local services may not work"
        RemoteMenuOption1Warning1 = "WARNING: Online multiplayer games may NOT work!"
        RemoteMenuOption1Warning2 = "(Diablo, CoD, etc. need inbound connections)"
        RemoteMenuOption2 = "Allow Remote Access + Local Services"
        RemoteMenuOption2Desc1 = "RDP stays ENABLED (for Tailscale/VPN access)"
        RemoteMenuOption2Desc2 = "Firewall allows localhost connections"
        RemoteMenuOption2Desc3 = "Best for: Gamers, remote servers, NUCs, development"
        RemoteMenuOption2Pro1 = "Pro: Remote access works, Docker/LLM/WSL functional"
        RemoteMenuOption2Pro2 = "Pro: Online multiplayer games WILL work!"
    ...
    de = @{
        ...
        RemoteMenuExample5 = "Online Multiplayer-Spiele (Diablo, Call of Duty, etc.)"
        RemoteMenuOption1 = "Maximale Sicherheit (Empfohlen fuer Desktop/Laptop)"
        RemoteMenuOption1Desc1 = "RDP vollstaendig DEAKTIVIERT"
        RemoteMenuOption1Desc2 = "Firewall blockiert ALLE eingehenden Verbindungen (ultra-strikt)"
        RemoteMenuOption1Desc3 = "Am besten fuer: Standard-Arbeitsplatz, Buero, Surfen"
        RemoteMenuOption1Pro = "Pro: Maximale Reduzierung der Angriffsflaeche"
        RemoteMenuOption1Con = "Contra: Kein Remote-Zugriff, lokale Dienste funktionieren evtl. nicht"
        RemoteMenuOption1Warning1 = "WARNUNG: Online Multiplayer-Spiele funktionieren evtl. NICHT!"
        RemoteMenuOption1Warning2 = "(Diablo, CoD, etc. benoetigen eingehende Verbindungen)"
        RemoteMenuOption2 = "Remote-Zugriff + Lokale Dienste erlauben"
        RemoteMenuOption2Desc1 = "RDP bleibt AKTIVIERT (fuer Tailscale/VPN-Zugriff)"
        RemoteMenuOption2Desc2 = "Firewall erlaubt Localhost-Verbindungen"
        RemoteMenuOption2Desc3 = "Am besten fuer: Gamer, Remote-Server, NUCs, Entwicklung"
        RemoteMenuOption2Pro1 = "Pro: Remote-Zugriff funktioniert, Docker/LLM/WSL funktional"
        RemoteMenuOption2Pro2 = "Pro: Online Multiplayer-Spiele funktionieren!"

...
function Show-ModuleSelection {
    ...
    $modules = @(
        ...
        @{
            ...
            Key = "WirelessDisplay"
            Description = "⚠️ BREAKS CASTING! Disables Miracast/Cast (Services, Firewall, Registry, Apps). Error message appears ONLY when clicking Cast button (not at startup). Skip if you need casting."
            Enabled = $true
            Mandatory = $false
        },
        @{

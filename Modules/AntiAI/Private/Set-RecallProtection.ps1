...
<#
.SYNOPSIS
    Applies additional Recall protection policies (app/URI deny lists, storage limits).
...
function Set-RecallProtection {
    ...
    Write-Log -Level DEBUG -Message "Applying Recall protection policies (deny lists + storage limits)" -Module "AntiAI"

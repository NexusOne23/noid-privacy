...
.NOTES
    ...
    Version: 2.1.0 (Extended validation)
...
function Test-AntiAICompliance {
    ...
    Write-Host "  ANTIAI COMPLIANCE VERIFICATION" -ForegroundColor Cyan
    Write-Host "  Registry-Based Policy Check" -ForegroundColor Cyan
    Write-Host "========================================" -ForegroundColor Cyan
    Write-Host "  Checking 24 AI Deactivation Policies" -ForegroundColor Cyan
    Write-Host "  + MS Policy Validation" -ForegroundColor DarkGray
    Write-Host "========================================`n" -ForegroundColor Cyan
...
Write-Host "[1/9] Checking Generative AI Master Switch..." -ForegroundColor Yellow
...
Write-Host "`n[2/9] Checking Recall Core Policies..." -ForegroundColor Yellow
$recallChecks = @(
...
Write-Host "`n[3/9] Checking Recall Enterprise Protection..." -ForegroundColor Yellow
...
Write-Host "`n[4/9] Checking Windows Copilot (4-layer defense)..." -ForegroundColor Yellow
$copilotChecks = @(
...
Write-Host "`n[5/9] Checking Click to Do..." -ForegroundColor Yellow
$clickChecks = @(
...
Write-Host "`n[6/9] Checking Paint AI..." -ForegroundColor Yellow
$paintChecks = @(
...
Write-Host "`n[7/9] Checking Notepad AI..." -ForegroundColor Yellow
$check = Test-RegistryValue `
...
Write-Host "`n[8/9] Checking Settings Agent..." -ForegroundColor Yellow
$check = Test-RegistryValue `
...
Write-Host "`n[9/9] Checking Additional Settings + MS Policy Validation..." -ForegroundColor Yellow
...
# MS POLICY VALIDATION: Check for alternative MS keys NOT set by AntiAI module
Write-Host "`n  MS Policy Validation (Conflict Scanner):" -ForegroundColor Cyan

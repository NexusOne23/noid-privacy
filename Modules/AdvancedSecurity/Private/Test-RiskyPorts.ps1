function Test-RiskyPorts {
    ...
    try {
        ...
        $ssdpRuleName = "NoID Privacy Pro - Block SSDP (UDP 1900)"
        ...
        if ($result.OpenPorts.Count -eq 0 -and $result.EnabledRules -eq 0) {
            # Ideal case: keine Hörer und keine erlaubenden Regeln
        ...
        elseif ($udp1900Open -and -not $otherOpenPorts -and $result.EnabledRules -eq 0 -and $ssdpBlockActive) {
            # Einziger offene Endpoint ist UDP 1900, aber durch NoID-Blockregel inbound geschützt

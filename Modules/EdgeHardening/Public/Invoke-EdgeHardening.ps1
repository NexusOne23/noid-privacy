...
function Invoke-EdgeHardening {
    ...
    process {
        try {
            ...
            Write-Host "========================================" -ForegroundColor Cyan
            Write-Host ""
            Write-Host "Applies Microsoft Edge v139 Security Baseline (18 core policies)" -ForegroundColor White
            ...
            Write-Host "  - Application-bound encryption, PUA protection" -ForegroundColor Gray
            Write-Host ""
            
            # INTERACTIVE: Ask about browser extensions (unless already specified via parameter)

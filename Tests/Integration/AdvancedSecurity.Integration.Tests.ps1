Describe "AdvancedSecurity Integration Tests" {
    ...
    Context "DryRun Execution" {
        ...
        It "Should run with Home profile in DryRun mode" {
            { Invoke-AdvancedSecurity -SecurityProfile "Home" -DryRun -ErrorAction Stop } | Should -Not -Throw
        }
        
        It "Should run with EnterpriseConservative profile in DryRun mode" {
            { Invoke-AdvancedSecurity -SecurityProfile "EnterpriseConservative" -DryRun -ErrorAction Stop } | Should -Not -Throw
        }
        
        It "Should run with AirGappedMax profile in DryRun mode" {
            { Invoke-AdvancedSecurity -SecurityProfile "AirGappedMax" -DryRun -ErrorAction Stop } | Should -Not -Throw
        }
